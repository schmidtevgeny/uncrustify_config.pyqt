...
<context>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="7995"/>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="6319"/>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="6920"/>
...
- trail_break trail_force переменные в столбик, знак в начале строки</translation>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="7061"/>
...
- thresh - порог - максимальное количество колонок</translation>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="7963"/>
...
`a(·, 1);`</translation>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="7813"/>
...
The value REMOVE will be overriden with FORCE</source>
        ...
        <translation type="obsolete">Добавить или убрать пробел после переменной `...`, если перед ней стоит непунктуатор.
...
The value REMOVE will be overriden with FORCE</source>
        ...
        <translation type="obsolete">Добавить или убрать пробел перед переменной `...`, если перед ней стоит непунктуатор.
...
`switch(i){case 1·...2:`</translation>
    ...
    <message>
        ...
        <translation type="obsolete">(D) Добавить или убрать пробел между типом и &apos;?&apos;.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="7995"/>
        <source>Add or remove space between &apos;)&apos; and &apos;...&apos;.</source>
...
overrides the indent of &apos;class&apos; continuation indents.</source>
        ...
        <translation type="obsolete">Отступ продолжения, только для строки (строк) заголовка класса. 
...
and nl_class_colon)</source>
        ...
        <translation type="obsolete">Дополнительный отступ перед ведущим двоеточием базового класса.
...
aligning. Set align_left_shift=false when enabling this.</source>
        ...
        <translation type="obsolete">Делать отступ для выражений с разбитым сдвигом (`&amp;lt;&amp;lt;` и `&amp;gt;&amp;gt;`) вместо выравнивания. 
...
2: Indent to the brace level</source>
        <comment>indent_paren_close</comment>
        <translation type="obsolete">- 0: Отступ до уровня тела (по умолчанию)
...
If true, aligns under the open brace.</source>
        ...
        <translation type="obsolete">Делать отступ для запятой, когда она находится внутри фигурной скобки.
...
If true, aligns under the open parenthesis.</source>
        ...
        <translation type="obsolete">Делать отступ для запятой, когда она находится внутри круглой скобки.
...
If true, aligns under the open parenthesis.</source>
        ...
        <translation type="obsolete">Делать отступ для булева оператора, когда он находится внутри круглой скобки.
...
if indent_bool_paren=true.</source>
        ...
        <translation type="obsolete">Выравнивать первое выражение по отношению к последующим если `indent_bool_paren=true`.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="7995"/>
        <source>Whether to align the first expression to following ones
...
direct-list-initialization.</source>
        ...
        <translation type="obsolete">Добавлять ли новую строку после типа в неименованном временном прямом списке инициализации.
...
precedence.</source>
        ...
        <translation type="obsolete">Количество пустых строк перед блоком определений переменных не в верхней части тела функции. Если `nl_after_access_spec` имеет ненулевое значение, то этот параметр имеет приоритет.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="7995"/>
        <source>0: No change (default).</source>
...
of a function body.</source>
        ...
        <translation type="obsolete">Количество пустых строк после блока определений переменных не в верхней части тела функции.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="7995"/>
        <source>0: No change (default).</source>
...
aligment)</source>
        ...
        <translation type="obsolete">(OC) Выравнивать параметры в вызове сообщения Objectve-C, если первое двоеточие не находится в следующей строке вызова сообщения (так же, как это делает Xcode)</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="7995"/>
...
blocks.</source>
        ...
        <translation type="obsolete">Единый стиль скобок для цепочки `if`/`else if`/`else`
...
inside of.</source>
        ...
        <translation type="obsolete">Делать отступ скобок блока непосредственно внутри #if, #else и #endif.
...
- at the opening brace</source>
        ...
        <translation type="obsolete">Значение может быть использовано дважды:
...
value &apos;true&apos;.</source>
        <comment>indent_cpp_lambda_only_once</comment>
        <translation type="obsolete">Чтобы предотвратить двойное использование значения отступа, используйте этот параметр со значением значением `true`.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="7813"/>
...
false: indentation will be used every time (default)</source>
        <comment>indent_cpp_lambda_only_once</comment>
        <translation type="obsolete">true: отступы будут использоваться только один раз
