...
<context>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="4520"/>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="13279"/>
        <source>Blank line options</source>
        <translation>Параметры пустых строк</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="7215"/>
...
- trail_break trail_force переменные в столбик, знак в начале строки</translation>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="7356"/>
        <source>Line splitting options help</source>
        <translation>Параметры разбивки длинных строк</translation>
    </message>
    <message>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="7410"/>
        <source>Code alignment options (not left column spaces/tabs) help</source>
        <translation>Разные декоративные выравнивания, типа имена переменных в один столбец.

Условия активации выравнивания:

- span - размах - минимальное число строк
- gap - зазор - минимальное количество колонок 
- thresh - порог - максимальное количество колонок</translation>
    </message>
    <message>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="8282"/>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="9758"/>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="9764"/>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="9770"/>
...
Работает только непосредственно перед символом кавычки.</translation>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="9782"/>
...
instead.</source>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="9788"/>
...
Усовершенствования в обнаружении шаблонов могут сделать эту опцию устаревшей.</translation>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="9794"/>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="9800"/>
...
Если `true`, то для отключения/включения обработки в комментариях будет выполняться regex-поиск в соответствии с указанными шаблонами.</translation>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="9830"/>
...
UTF-8, then output as UTF-8.</source>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="9844"/>
        <source>Add or remove space around non-assignment symbolic operators (&apos;+&apos;, &apos;/&apos;, &apos;%&apos;,
&apos;&lt;&lt;&apos;, and so forth).</source>
        <comment>sp_arith</comment>
        <translation>Добавить или убрать пробел вокруг символов операторов, не относящихся к присваиванию (`+`, `/`, `%`, `&lt;&lt;` и так далее).

`x=x·+·5·/·y;`</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="9850"/>
        <source>Add or remove space around arithmetic operators &apos;+&apos; and &apos;-&apos;.</source>
        <comment>sp_arith_additive</comment>
        <translation>Добавить или убрать пробел вокруг символов арифметических операторов `+` и `-`.
...
`x=x·+·5/y;`</translation>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="9856"/>
        <source>Add or remove space around assignment operator &apos;=&apos;, &apos;+=&apos;, etc.</source>
        <comment>sp_assign</comment>
        <translation>Добавить или убрать пробел вокруг символов операторов c  присваиванием (`=`, `+=`, и тому подобное).
...
`x·+=·7;`</translation>
    ...
    <message>
        ...
        <translation>Добавить или убрать пробел вокруг &apos;=&apos; в спецификации захвата лямбды в C++11.

`auto d = [·=·](int *a, Something &amp; b){std::cout &lt;&lt; &quot;blah: &quot; &lt;&lt; *a;};`</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="9862"/>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="9868"/>
...
an argument list is present, as in &apos;[] &lt;here&gt; (int x){ ... }&apos;.</source>
        ...
        <translation>Добавить или убрать пробел после спецификации захвата лямбды C++11, когда присутствует список аргументов

`auto d = [=]·(int *a, Something &amp; b){std::cout &lt;&lt; &quot;blah: &quot; &lt;&lt; *a;};`</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="9874"/>
...
no argument list is present, as in &apos;[] &lt;here&gt; { ... }&apos;.</source>
        ...
        <translation>Добавить или убрать пробел после спецификации захвата лямбды C++11 без списка аргументов

`auto d = []·{return 5;};`</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="9886"/>
...
&apos;[]( &lt;here&gt; int x &lt;here&gt; ){ ... }&apos;.</source>
        ...
        <translation>Добавить или убрать пробел после открывающей скобки и перед закрывающей скобкой в списке аргументов лямбды C++11

`auto d = [=](·int *a, Something &amp; b·){std::cout &lt;&lt; &quot;blah: &quot; &lt;&lt; *a;};`</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="9892"/>
        <source>Add or remove space after the argument list of a C++11 lambda, as in
&apos;[](int x) &lt;here&gt; { ... }&apos;.</source>
        <comment>sp_cpp_lambda_paren_brace</comment>
        <translation>Добавить или убрать пробел после списка аргументов лямбды C++11

`auto d = [=](int *a, Something &amp; b)·{std::cout &lt;&lt; &quot;blah: &quot; &lt;&lt; *a;};`</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="9898"/>
...
immediately invoked lambda, as in &apos;[]( ... ){ ... } &lt;here&gt; ( ... )&apos;.</source>
        ...
        <translation>Добавить или убрать пробел между телом лямбды и ее оператором вызова немедленно вызываемой лямбды.

`auto d = [=](int *a, Something &amp; b){std::cout &lt;&lt; &quot;blah: &quot; &lt;&lt; *a;}·(a, b);`</translation>
    </message>
    <message>
...
`Foo( unsigned int boo·=·999 );`</translation>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="9910"/>
...
`x·=5; y·+=7;`</translation>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="9916"/>
...
`x=·5; y+=·7;`</translation>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="9928"/>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="9934"/>
...
`enum {
    ...
    <message>
        <location filename="uncrustify_ui.py" line="9940"/>
...
`enum {
    ...
    <message>
        <location filename="uncrustify_ui.py" line="9952"/>
        <source>Add or remove space around assignment &apos;:&apos; in enum.</source>
...
`enum class form·:·int{one, two};`</translation>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="9958"/>
        <source>Add or remove space around preprocessor &apos;##&apos; concatenation operator.</source>
        <comment>sp_pp_concat</comment>
        <translation>Добавить или убрать пробел вокруг препроцессорной команды конкатенации `##`.

`#define inline(i) inline_·##·i`</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="9964"/>
...
`#define WARN_IF(EXP) do { if (EXP) fprintf (stderr, &quot;Warning: &quot; #·EXP &quot;\n&quot;); } \`</translation>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="9970"/>
...
`#define WARN_IF(EXP) do { if (EXP) fprintf (stderr, &quot;Warning: &quot;·#EXP &quot;\n&quot;); } \`</translation>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="9976"/>
...
inline decltype(auto) Invoke(Fun·&amp;&amp;·f, Args·&amp;&amp;·... args); // !`</translation>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="9982"/>
...
`for (i = 0; i·&lt;·5; i++) bar(i);`</translation>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="9994"/>
...
`__attribute__(·(visibility (&quot;default&quot;)·)·) int* i;`</translation>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="10000"/>
...
`STDMETHOD(GetValues)·(BSTR bsName, REFDATA** pData);`</translation>
    ...
    <message>
        <location filename="ui_0771f.py" line="9798"/>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="10006"/>
...
`void f()noexcept()·{}`</translation>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="10012"/>
...
`chunk_t·*pc;`</translation>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="10024"/>
...
`int·*X(int *i, int ·*)`</translation>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="10060"/>
...
`int·***a;`</translation>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="10072"/>
...
`int***·a;`</translation>
    ...
    <message>
        ...
        <translation>(CLI.NET) Добавить или убрать пробел после символа указателя &apos;^&apos;, если за ним следует слово.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="10084"/>
...
function prototype or function definition.</source>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="10102"/>
...
in a function pointer definition.</source>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="10114"/>
...
parenthesis, as in &apos;void* (*)()&apos;.</source>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="10132"/>
...
function prototype or function definition.</source>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="10144"/>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="10150"/>
...
Если установлено значение ignore, вместо него используется `sp_before_byref`.
    ...
    <message>
        <location filename="uncrustify_ui.py" line="10156"/>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="10162"/>
...
prototype or function definition.</source>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="10180"/>
...
following word.</source>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="10186"/>
...
Если установлено значение `ignore`, используется `sp_before_angle`.
    ...
    <message>
        <location filename="ui_0771f.py" line="9984"/>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="10222"/>
        <source>Add or remove space between &apos;&gt;&apos; and &apos;:&apos;.</source>
...
`template&lt; &gt;struct Bar&lt; false &gt;·: Foo{};`</translation>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="10228"/>
...
`do { amime3(); } while·(false);`</translation>
    ...
    <message>
        <location filename="ui_0771f.py" line="10122"/>
...
buf = new unsigned char·[1024];</translation>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="10438"/>
    ...
    <message>
        <location filename="ui_0771f.py" line="10206"/>
        <source>Add or remove space inside &apos;[]&apos;.</source>
...
`void d(double[·]x);`</translation>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="10450"/>
...
Если установлено значение ignore, используется sp_inside_square.</translation>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="10462"/>
...
`#define LOG_FMT (sev, args...·)`</translation>
    </message>
    <message>
    ...
    template&lt;class R, typename ...Args&gt;
    void call1r(R(*fp)(Args&amp;&amp;·...));</translation>
    </message>
    <message>
        ...
        <translation>Добавить или убрать пробел между `)` и классификатором, таким как `const`.

`float fabs(fload x)·const`</translation>
    </message>
    <message>
        ...
        <translation>Добавить или убрать пробел между `)` и `noexcept`

`float fabs(fload x)·noexept`</translation>
    </message>
    <message>
        ...
        <translation>Добавить или убрать пробел после двоеточия класса.

`class my_class:·baseclass1{}`</translation>
    </message>
    <message>
        ...
        <translation>Добавить или удалять пробел перед двоеточием класса.
...
`class my_class·:baseclass1{}`</translation>
    ...
    <message>
        ...
        <translation>Добавить или удалять пробел после двоеточия конструктора класса.

`my_class::my_class(int b):·x(b){...}`</translation>
    </message>
    <message>
        ...
        <translation>Добавить или удалять пробел перед двоеточием конструктора класса.
...
`my_class::my_class(int b)·:x(b){...}`</translation>
    ...
    <message>
        ...
        <translation>Добавить или удалять пробел перед двоеточием в case.
...
`case 1·:`</translation>
    ...
    <message>
        ...
        <translation>Добавить или убрать пробел между `operator` и знаком оператора.

`T operator·+(T v)`</translation>
    </message>
    <message>
...
in &apos;operator ++(&apos;.</source>
        ...
        <translation>Добавить или убрать пробел между символом оператора и открывающей скобкой
...
&apos;operator *()&apos;.</source>
        ...
        <translation>Отменяет `sp_after_operator_sym`, когда оператор не имеет аргументов
...
&apos;(int)a&apos; vs. &apos;(int) a&apos;.</source>
        ...
        <translation>Добавить или убрать пробел после C/D каста
    ...
    <message>
        ...
        <translation>Добавить или убрать пробелов внутри круглых скобок в преобразовании типов.
...
i.e. &apos;int(exp)&apos; vs. &apos;int (exp)&apos;.</source>
        ...
        <translation>Добавить или убрать пробел между типом и открывающей круглой скобкой при приведении в C++
...
`int·(exp)`</translation>
    ...
    <message>
        ...
        <translation>Добавить или убрать пробел между `sizeof` и `(`.

`a=sizeof·(int)`</translation>
    </message>
    <message>
...
`template &lt;typename... Args&gt; std::size_t GetSize (Args&amp;&amp;... args) { std::size_t Count= sizeof·...(Args);  return Count;}`</translation>
    </message>
    <message>
...
`template &lt;typename... Args&gt; std::size_t GetSize (Args&amp;&amp;... args) {    std::size_t Count= sizeof...·(Args);    return Count;}</translation>
    ...
    <message>
        ...
        <translation>Добавить или убрать пробел между `...` и упаковкой параметров.
    ...
    <message>
        ...
        <translation>Добавить или убрать пробел между упаковкой параметров и `...`.

    template&lt;class R, typename ...Args&gt;
    struct invoke1v : invoke&lt;R(*)(Args·...)&gt;{};</translation>
    </message>
    <message>
        ...
        <translation>Добавить или убрать пробел между  `decltype` и `(`.

`auto a=decltype·(x){10};`</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Добавить или убрать пробел внутри enum `{` и `}`.

`enum Status {·Unknown, Success, Error·};`</translation>
    </message>
    <message>
        ...
        <translation>Добавить или убрать пробел внутри struct/union `{` и `}`.

`union {·int m_size; int m_any;·};`</translation>
    </message>
    <message>
...
works only if sp_brace_brace is set to ignore.</source>
        ...
        <translation>Добавить или убрать пробел после открывающей скобки в безымянном временном прямом списке-инициализации, если оператор является инициализатором списком 
...
works only if sp_brace_brace is set to ignore.</source>
        ...
        <translation>Добавить или убрать пробел перед закрывающей скобкой в безымянном временном прямом списке-инициализации, если оператор является инициализатором списком 
...
works only if sp_before_type_brace_init_lst_close is set to ignore.</source>
        ...
        <translation>Добавить или убрать пробел внутри безымянного временного прямого списка-инициализации, если оператор является инициализацией списком 

- работает только если `sp_brace_brace` имеет значение `ignore`
- работает только если `sp_before_type_brace_init_lst_close` имеет значение `ignore`.
...
`int a0[][] = {·{·1·}·};`</translation>
    ...
    <message>
        ...
        <translation>Добавить или убрать пробел внутри `{` и `}`.

`while(1){·i++;·}`</translation>
    </message>
    <message>
        <location filename="ui_0771f.py" line="10458"/>
        <source>Add or remove space inside &apos;{}&apos;.</source>
...
`while(1){·}`</translation>
    ...
    <message>
        ...
        <translation>Добавить или убрать пробел вокруг оператора `-&gt;`.

`auto max(int a, int b)·-&gt;·int;`</translation>
    </message>
    <message>
...
is forced except for pointer return types.</source>
        ...
        <translation>Добавить или убрать пробел между возвращаемым типом и именем функции. 

Минимум 1 обязателен, за исключением типов возврата указателей.

`int ·c(int &amp;);int*·c(int &amp;){}`</translation>
    </message>
    <message>
...
direct-list-initialization.</source>
        ...
        <translation>Добавить или убрать пробел между типом и открывающей скобкой безымянного временного прямого списка-инициализации.

`auto i12 = int·{42};`</translation>
    </message>
    <message>
        ...
        <translation>Добавить или убрать пробел между именем функции и `(` в объявлении функции.

`void f·(int i);`</translation>
    </message>
    <message>
        <location filename="ui_0771f.py" line="10488"/>
...
without parameters.</source>
        ...
        <translation>Добавить или убрать пробел между именем функции и &apos;()&apos; при объявлении функции без параметров.
...
`void f·();`</translation>
    ...
    <message>
        ...
        <translation>Добавить или убрать пробел между именем функции и `(` при использовании спецификатора `typedef`.

`typedef void timer_cb·(struct timer_node *n);`</translation>
    </message>
    <message>
        ...
        <translation>Добавить или убрать пробел между именем псевдонима и `(` типа не указателя функции `typedef`.

`int a·(int b) {};`</translation>
    </message>
    <message>
        <location filename="ui_0771f.py" line="10506"/>
        <source>Add or remove space between function name and &apos;()&apos; on function definition
without parameters.</source>
        <comment>sp_func_def_paren_empty</comment>
        <translation>Добавить или убрать пробел между именем функции и `()` в определении функции без параметров.
...
Overrides sp_after_angle unless use_sp_after_angle_always is set to true.</source>
        ...
        <translation>Добавляет или удаляет пробел внутри пустых скобок функции `()`.

Переопределяет `sp_after_angle`, если для `use_sp_after_angle_always` не установлено значение `true`.
...
`int a (·){}`</translation>
    ...
    <message>
        ...
        <translation>Добавить или убрать пробел внутри скобок функции.

    # void ( int a ) (·int b·);
    int printx(·const char* fmt, ...·); </translation>
    </message>
    <message>
...
&apos;void (*x)(...)&apos;.</source>
        ...
        <translation>Добавить или убрать пробел внутри первых круглых скобок в типе функции
...
&apos;void (*x)(...)&apos;.</source>
        ...
        <translation>Добавить или убрать пробел между &apos;)&apos; и `(` в типе функции
...
`void (*x)·(...)`</translation>
    ...
    <message>
        ...
        <translation>Добавить или удалять пробел между `]` и `(` при вызове функции.

`function_list[ idx ]·(param);`</translation>
    </message>
    <message>
        ...
        <translation>Добавить или убрать пробел между `)` и `{` в функции.
...
initialization.</source>
        ...
        <translation>Добавить или убрать пробел между `)` и `{` вызова функции при инициализации объекта.

`ProcessStartInfo(&quot;smthg&quot;)·{Arguments = string.Format(&quot;-9 --ss -S aa \&quot;{0}\&quot;&quot;, file),WorkingDirectory = Directory.GetCurrentDirectory()};`</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="10804"/>
    ...
    <message>
        ...
        <translation>Добавить или убрать пробела между именем функции и `(` при вызове функции.
...
parameters. If set to ignore (the default), sp_func_call_paren is used.</source>
        ...
        <translation>Добавить или убрать пробела между именем функции и `()` при вызове функции без параметров. 
Если установлено значение `ignore` (по умолчанию), используется sp_func_call_paren.
...
like:
  set func_call_user tr _ i18n</source>
        ...
        <translation>Добавить или убрать пробел между именем пользовательской функции и `(` при вызове функции. 
...
`foo·(ABC)`</translation>
    ...
    <message>
        ...
        <translation>Добавить или убрать пробел внутри скобок пользовательской функции.
...
i.e. &apos;((&apos; vs. &apos;( (&apos;.</source>
        ...
        <translation>Добавить или убрать пробел между вложенными круглыми скобками в пользовательских функциях
...
parenthesis.</source>
        ...
        <translation>Добавить или убрать пробел между конструктором/деструктором и открывающей скобкой.

`myclass·(int i){`</translation>
    </message>
    <message>
...
and &apos;()&apos;.</source>
        ...
        <translation>Добавить или убрать пробел между конструктором без параметров или деструктором и `()`.
...
`myclass·(){`</translation>
    ...
    <message>
        ...
        <translation>Добавить или убрать пробел после `return`.
...
`return·-1;`</translation>
    ...
    <message>
        ...
        <translation>Добавить или убрать пробел между `return` и `(`.
...
`return·{ -1, -1, -1 };`</translation>
    ...
    <message>
        ...
        <translation>Добавить или убрать пробел между `__attribute__` и `(`.

`struct sockaddr *sa __attribute__·((unused))`</translation>
    </message>
    <message>
        ...
        <translation>Добавить или убрать пробел между `defined` и `(` в `#if defined (FOO)`.

`#if defined·(FOO)`</translation>
    </message>
    <message>
        ...
        <translation>Добавить или убрать пробел между `throw` и `(`

`throw·(something)`</translation>
    </message>
    <message>
...
&apos;@throw [...];&apos;.</source>
        ...
        <translation>Добавить или убрать пробел между `throw` и любым другим словом, кроме `(`
...
If set to ignore, sp_before_sparen is used.</source>
        ...
        <translation>Добавить или убрать пробел между `catch` и `(` в `catch·(something) { }`.
...
in &apos;@catch (something) { }&apos;. If set to ignore, sp_catch_paren is used.</source>
        ...
        <translation>(OC) Добавить или убрать пробел между `@catch` и `(` в `@catch (something) { }`.
...
as in &apos;@protocol Protocol&lt;here&gt;&lt;Protocol_A&gt;&apos; or &apos;@interface MyClass : NSObject&lt;here&gt;&lt;MyProtocol&gt;&apos;.</source>
        ...
        <translation>(OC) Добавить или убрать пробел перед списком протоколов Objective-C, как в `@protocol Protocol·&lt;Protocol_A&gt;&apos; или &apos;@interface MyClass : NSObject·&lt;MyProtocol&gt;&apos;.</translation>
    </message>
    <message>
...
in &apos;version (something) { }&apos;. If set to ignore, sp_before_sparen is used.</source>
        ...
        <translation>(D) Добавить или убрать пробел между `version` и `(` в `version (something) { }`
...
in &apos;scope (something) { }&apos;. If set to ignore, sp_before_sparen is used.</source>
        ...
        <translation>(D) Добавить или убрать пробел между `scope` и `(` в `scope (something) { }`
...
Если установлено значение `ignore`, используется `sp_before_sparen`.</translation>
    ...
    <message>
        ...
        <translation>Добавить или убрать пробел между `super` и `(` в `super (something)`.</translation>
    </message>
    <message>
        ...
        <translation>Добавить или убрать пробел между `this` и `(`

`this·(something)`</translation>
    </message>
    <message>
        ...
        <translation>Добавить или убрать пробела между именем макроса и его определением.

`#define FS_NOCOW_FL·0x00800000`</translation>
    </message>
    <message>
        ...
        <translation>Добавить или убрать пробела между скобкой макрофункции `)` и ее определением.

`#define log(x)·qMessage(x.toStdString().c_str());`</translation>
    </message>
    <message>
        ...
        <translation>Добавить или убрать пробел между &apos;else&apos; и `{`, если на той же строке.

`if(i&gt;0){i++;}else·{i=-i;}`</translation>
    </message>
    <message>
        ...
        <translation>Добавить или убрать пробел между `}` и `else`, если на той же строке.
...
`if(i&gt;0){i++;}·else{i=-i;}`</translation>
    ...
    <message>
        ...
        <translation>Добавить или убрать пробел между `}` и именем набранного текста в той же строке.

`typedef struct { int val; int sel; }·DiceInfo;`</translation>
    </message>
    <message>
...
&apos;catch&apos; are on the same line, as in &apos;catch (decl) &lt;here&gt; {&apos;.</source>
        ...
        <translation>Добавить или убрать пробел перед `{` оператора `catch`, если они находятся на одной строке

`catch (decl)·{`</translation>
    </message>
    <message>
...
Если установлено значение ignore, используется sp_catch_brace.</translation>
    ...
    <message>
        ...
        <translation>Добавить или убрать пробел между &apos;}&apos; и &apos;catch&apos;, если на той же строке.
...
Если установлено значение ignore, используется sp_brace_catch.</translation>
    ...
    <message>
        ...
        <translation>Добавить или убрать пробел между `finally` и `{`, если на той же строке.

`}finally (decl)·{`</translation>
    </message>
    <message>
        ...
        <translation>Добавить или убрать пробел между `}` и `finally`, если на той же строке.
...
`}·finally (decl){`</translation>
    ...
    <message>
        ...
        <translation>Добавить или убрать пробел между `try` и `{`, если на той же строке.
...
`try·{`</translation>
    ...
    <message>
        ...
        <translation>Добавить или убрать пробел между `get/set` и `{`, если на той же строке.
...
initialization.</source>
        ...
        <translation>Добавить или убрать пробел между переменной и `{` для унифицированной инициализации в C++.
...
`int a·{5};`</translation>
    ...
    <message>
        ...
        <translation>Добавить или убрать пробела между переменной и `{` для пространства имен.

`namespace std·{`</translation>
    </message>
    <message>
        ...
        <translation>Добавить или убрать пробел перед оператором `::`.

`class Parser·::ParserPrivate { }`</translation>
    </message>
    <message>
        ...
        <translation>Добавить или удалять пробел после оператора `::`
...
`class Parser::·ParserPrivate { };`</translation>
    ...
    <message>
        ...
        <translation>(D) Добавить или убрать вокруг оператора инициализатора именованного массива в D &apos;:&apos;.</translation>
    </message>
    <message>
        ...
        <translation>Добавить или удалять пробел после оператора `!` (не).

`if(!·a)`</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="11068"/>
        <source>Add or remove space after the &apos;~&apos; (invert) unary operator.</source>
        <comment>sp_inv</comment>
        <translation>Добавить или удалять пробел после оператора `~` (инвертор).
...
affect the spacing after a &apos;&amp;&apos; that is part of a type.</source>
        ...
        <translation>Добавить или убрать пробела после унарного оператора `&amp;` (адрес). 

Это не влияет на пробел после `&amp;`, который является частью типа.

i=s.toDouble(&amp;·ok);</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="11080"/>
        <source>Add or remove space around the &apos;.&apos; or &apos;-&gt;&apos; operators.</source>
        <comment>sp_member</comment>
        <translation>Добавить или удалять пробелы вокруг операторов `.` или `-&gt;`

`ui·-&gt;·Label1·-&gt;·text()·.·toDouble()`</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="11086"/>
...
not affect the spacing after a &apos;*&apos; that is part of a type.</source>
        ...
        <translation>Добавить или убрать пробел после унарного оператора `*` (разыменование). 
...
`int a=*·b;`</translation>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="11092"/>
        <source>Add or remove space after &apos;+&apos; or &apos;-&apos;, as in &apos;x = -5&apos; or &apos;y = +7&apos;.</source>
        <comment>sp_sign</comment>
        <translation>Добавить или убрать пробел после унарного `+` или `-`

`x = -·5;y = +·7`</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="11098"/>
        <source>Add or remove space between &apos;++&apos; and &apos;--&apos; the word to which it is being
applied, as in &apos;(--x)&apos; or &apos;y++;&apos;.</source>
        <comment>sp_incdec</comment>
        <translation>Добавить или убрать пробел между `++` и `--` словом, к которому он применяется

`(--·x);y·++;`</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="11104"/>
        <source>Add or remove space before a backslash-newline at the end of a line.</source>
        <comment>sp_before_nl_cont</comment>
        <translation>Добавить или убрать пробел перед обратным слешем в конце строки.
...
or &apos;+(int) bar;&apos;.</source>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="11116"/>
...
i.e. &apos;-(int) f: (int) x;&apos; vs. &apos;-(int) f : (int) x;&apos;.</source>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="11128"/>
...
&apos;NSDictionary *test = @{@&quot;foo&quot; :@&quot;bar&quot;};&apos;.</source>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="11134"/>
...
&apos;NSDictionary *test = @{@&quot;foo&quot; :@&quot;bar&quot;};&apos;.</source>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="11140"/>
        <source>(OC) Add or remove space after the colon in message specs,
i.e. &apos;[object setValue:1];&apos; vs. &apos;[object setValue: 1];&apos;.</source>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="11146"/>
        <source>(OC) Add or remove space before the colon in message specs,
i.e. &apos;[object setValue:1];&apos; vs. &apos;[object setValue :1];&apos;.</source>
...
Also applies to &apos;@protocol()&apos; constructs.</source>
        ...
        <translation>(OC) Добавить или убрать пробел внутри скобок &apos;@selector&apos;, т.е. &apos;@selector(foo)&apos; против &apos;@selector( foo )&apos;.
...
i.e. &apos;@synchronized(foo)&apos; vs. &apos;@synchronized (foo)&apos;.</source>
        ...
        <translation>(OC) Добавить или убрать пробел между &apos;@synchronized&apos; и открывающей скобкой, т.е. &apos;@synchronized(foo)&apos; против &apos;@synchronized (foo)&apos;.</translation>
    </message>
    <message>
        ...
        <translation>Добавить или убрать пробел вокруг `:` в `b ? t·:·f`</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Добавить или убрать место вокруг `?` в `b·?·t : f`.</translation>
    </message>
    <message>
...
and &apos;:&apos;.</source>
        ...
        <translation>В сокращенной тернарной форме `(a?·: b)` добавить или удалить пробел между `?` и `:`.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="11248"/>
...
as in &apos;for (Type var : &lt;here&gt; expr)&apos;.</source>
        ...
        <translation>Добавить или убрать пробел после `:` в основанном на диапазоне `for` в Java/C++11

     for (Type var:·expr){}</translation>
    </message>
    <message>
...
as in &apos;for (Type var &lt;here&gt; : expr)&apos;.</source>
        ...
        <translation>Добавить или убрать пробел перед `:` в основанном на диапазоне `for` в Java/C++11
    ...
    <message>
        ...
        <translation>Добавить или удалять пробел после открытия комментария C++ `//·AAA`</translation>
    </message>
    <message>
...
with either &apos;BEGIN&apos; or &apos;END&apos;.</source>
        ...
        <translation>Добавить или убрать пробел в комментарии маркера региона C++, как в `// · BEGIN`.
...
or meta-data comments like &apos;//:&apos;, &apos;//=&apos;, and &apos;//~&apos;.</source>
    ...
    <message>
        ...
        <translation>Добавить или убрать пробел между #else или #endif и замыкающим комментарием.
    ...
    <message>
        ...
        <translation>Добавить или удалять пробел после `new`, `delete` и `delete[]`.
    ...
    <message>
        ...
        <translation>Добавить или убрать пробел между `new` и `(` в `new()`.

    Foo* foo = new·(ptr,std::nothrow)Foo[];
    Foo* foo = new·(ptr)Foo();
    Foo* foo = new·(FOO(ptr))Foo();</translation>
    </message>
    <message>
        ...
        <translation>Добавить или убрать пробел между `)` и типом в `new(foo) BAR`.
...
as in &apos;new(foo) BAR&apos;.</source>
        ...
        <translation>Добавить или убрать пробел после открывающей скобки оператора new
...
as in &apos;new(foo) BAR&apos;.</source>
        ...
        <translation>Добавить или убрать пробел перед закрывающей скобкой оператора new
    ...
    <message>
        ...
        <translation>Добавить или убрать пробел перед завершающим комментарием.

    return(0);·//cpd.settings[UO_indent_braces].n;</translation>
    </message>
    <message>
        ...
        <translation>Количество пробелов перед завершающим комментарием.</translation>
    </message>
    <message>
        ...
        <translation>Добавить или убрать пробел перед встроенным комментарием.

    int a,·/* b , c, */ d; // trailing cmt</translation>
    </message>
    <message>
        ...
        <translation>Количество пробелов перед встроенным комментарием.</translation>
    </message>
    <message>
        ...
        <translation>Добавить или убрать пробел после встроенного комментария.
    ...
    <message>
        ...
        <translation>Количество пробелов после встроенного комментария.</translation>
    </message>
    <message>
        ...
        <translation>(Java) Добавить или убрать пробел между аннотацией и открывающей круглой скобкой.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Добавить или убрать пробел после `noexcept`.

    Foo() noexcept·() {}</translation>
    </message>
    <message>
        ...
        <translation>Добавить или убрать пробел после `_`.

    new Gtk.Label (_·(&quot;Label text&quot;));</translation>
    </message>
    <message>
        ...
        <translation>Если переменная имеет значение true, то после #define вставляется \t.
    ...
    <message>
        ...
        <translation>Количество столбцов для отступа на один уровень. Обычно 2, 3, 4 или 8.</translation>
    </message>
    <message>
...
absolute and not increased for each &apos;(&apos; or &apos;[&apos; level.</source>
        ...
        <translation>Отступ продолжения. Если значение ненулевое, оно переопределяет размер отступов продолжения для `(`, `[` и `=`. 

Отрицательные значения допустимы; отрицательное значение является абсолютным и не увеличивается для каждого уровня `(` или `[`.
...
the newline character).</source>
        ...
        <translation>Делать ли отступ для пустых строк (т.е. строк, содержащих только пробелы до символа новой строки).</translation>
    </message>
    <message>
...
overrides the indent.</source>
        ...
        <translation>Отступ продолжения для `func_*_param`, если они истинны. Если значение ненулевое, оно переопределяет отступ.
...
Требуется `indent_align_string=true`.
    ...
    <message>
        <location filename="uncrustify_ui.py" line="11520"/>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="11532"/>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="11538"/>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="11544"/>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="11550"/>
...
i.e. &apos;if&apos; =&gt; 3 spaces, &apos;for&apos; =&gt; 4 spaces, etc.</source>
        ...
        <translation>Отступ должен основываться на размере родительской скобки, т.е. `if` - 3 пробела, `for` - 4 пробела и т.д.
...
in &apos;({\n&apos;.</source>
        ...
        <translation>Делать отступ на основе открывающей круглой скобки вместо открывающей фигурной скобки в `({\n`.
...
`true`
    ...
    <message>
        <location filename="uncrustify_ui.py" line="11562"/>
        <source>(C#) Whether to indent the brace of a C# delegate by another level.</source>
        <comment>indent_cs_delegate_brace</comment>
        <translation>(C#) Добавить отступы от скобки блока `delegate` на следующий уровень.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="11568"/>
...
another level.</source>
        ...
        <translation>(C#) Добавить отступы от блока `delegate`, если не используются скобки.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="11574"/>
        <source>Whether to indent the body of a &apos;namespace&apos;.</source>
        <comment>indent_namespace</comment>
        <translation>Добавить отступы в тело `namespace`.
...
namespace Constants
    ...
    <message>
        <location filename="uncrustify_ui.py" line="11580"/>
...
Requires indent_namespace=true.</source>
        ...
        <translation>Отступ только для первого пространства имен, а не для всех вложенных пространств имен.
...
Если установлено в ноль, используется значение `indent_columns`
    ...
    <message>
        <location filename="uncrustify_ui.py" line="11592"/>
...
0 - без ограничений</translation>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="11604"/>
        <source>Whether the &apos;extern &quot;C&quot;&apos; body is indented.</source>
        <comment>indent_extern</comment>
        <translation>Отступ для тела `extern &quot;C&quot;`.
    ...
    <message>
        <location filename="uncrustify_ui.py" line="11610"/>
        <source>Whether the &apos;class&apos; body is indented.</source>
        <comment>indent_class</comment>
        <translation>Отступ в теле класса
    ...
    <message>
        ...
        <translation>Добавить отступы после ведущего двоеточия базового класса.</translation>
    </message>
    <message>
...
colon. Requires indent_class_colon=true.</source>
        ...
        <translation>Отступ основываться на двоеточии класса, а не на том, что находится после двоеточия. 
...
Требуется, чтобы `indent_class_colon=true`.</translation>
    ...
    <message>
        ...
        <translation>Добавить отступы после двоеточия инициализатора ведущего класса.
    ...
    <message>
        ...
        <translation>Виртуальный отступ от `:` для ведущих инициализаторов членов.</translation>
    </message>
    <message>
        ...
        <translation>Виртуальный отступ от `:` для следующих инициализаторов членов.</translation>
    </message>
    <message>
...
Negative values decrease indent down to the first column.</source>
        ...
        <translation>Дополнительный отступ для списка инициализаторов конструктора.
...
If false, &apos;else\nif&apos; is treated as &apos;else if&apos; for indenting purposes.</source>
        ...
        <translation>Отступ `if` после `else` должен быть новым блоком под `else`.
Если `false`, то `else\nif` рассматривается как `else if`.
    ...
    <message>
        ...
        <translation>Сумма отступов объявлений переменных после открывающей скобки.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="11676"/>
        <source> &lt;0: Relative
...
- &gt;=0: Абсолютный</translation>
    ...
    <message>
        ...
        <translation>Добавить отступы от разбитых определений переменных вместо выравнивания.
    ...
    <message>
        ...
        <translation>Определение функций начинаться в колонке 1.
...
rather than aligning parameters under the open parenthesis.</source>
        ...
        <translation>Добавить отступы для разбитых параметров вызова функции на один уровень отступа, а не выравнивать параметры под открывающей круглой скобкой.
...
rather than aligning parameters under the open parenthesis.</source>
        ...
        <translation>Добавить отступы для разбитых параметров в определении функции, а не выравнивать параметры под открывающей круглой скобкой.
...
if paren position is more than the option value</source>
        ...
        <translation>Для определений функции при `indent_func_def_param=false` позволяет выравнивать параметры или делать отступы при необходимости. Если скобка расположена на позиции больше данного числа, то делается отступ, иначе выравнивание.
...
rather than aligning parameters under the open parenthesis.</source>
        ...
        <translation>Добавить отступы для разбитых параметров в объявлении функции, а не выравнивать параметры под открывающей круглой скобкой.
...
rather than aligning parameters under the open parenthesis.</source>
        ...
        <translation>Добавить отступы для разбитых параметров в определении функции класса, а не выравнивать параметры под открывающей круглой скобкой.
...
rather than aligning parameters under the open parenthesis.</source>
        ...
        <translation>Добавить отступы для разбитых параметров в конструкторе, а не выравнивать параметры под открывающей круглой скобкой.</translation>
    </message>
    <message>
...
rather than aligning parameters under the open parenthesis.</source>
        ...
        <translation>Добавить отступы для разбитых параметров шаблона, а не выравнивать параметры под открывающей круглой скобкой.
...
Использует оба значения опций `indent_columns` и `indent_param`.</translation>
    </message>
    <message>
...
prototype.</source>
        ...
        <translation>Колонка отступов для отдельного квалификатора &apos;const&apos; в прототипе функции.
...
prototype.</source>
        ...
        <translation>Колонка для отдельного квалификатора &apos;throw&apos; в прототипе функции.
...
`do { ... } while (0)` blocks bracketing them.</source>
        ...
        <translation>Как делать отступ внутри макроса со скобкой на той же строке 
...
false: do not add an indent for the brace on the same line as the macro</source>
        <comment>indent_macro_brace</comment>
        <translation>- true: добавлять отступ для скобки в той же строке, что и макрос
- false: не добавлять отступ для скобки в той же строке, что и макрос</translation>
    </message>
    <message>
...
Usually set to 0, 1, or indent_columns.</source>
        ...
        <translation>Количество пробелов для отступа от продолжения `-&gt;` или `.`.
...
The indent_member option will not be effective if this is set to true.</source>
        ...
        <translation>Должны ли строки, разорванные на `.` или `-&gt;`, отступать на один отступ.
...
Опция `indent_member` не будет действовать, если установлено значение `true`.
    ...
    <message>
        ...
        <translation>Пробелы для отступа однострочных (&apos;//&apos;) комментариев на строках после кода.</translation>
    </message>
    <message>
...
the indent level by this value. Negative values decrease the indent level.</source>
        ...
        <translation>При открытии круглой скобки для управляющего оператора (if, for, while и т.д.) увеличить уровень отступа на это значение. Отрицательные значения уменьшают уровень отступа.</translation>
    </message>
    <message>
...
instead of trying to keep the same absolute column.</source>
        ...
        <translation>Нужно ли делать отступ для комментариев в одну строку (&apos;//&apos;) относительно кода вместо того, чтобы пытаться сохранить тот же абсолютный столбец.</translation>
    </message>
    <message>
...
It might be wise to choose the same value for the option indent_case_brace.</source>
        ...
        <translation>Размер отступа `case` от `switch`. Обычно 0 или `indent_columns`.
Возможно, будет разумно выбрать такое же значение для параметра `indent_case_brace`.
...
Usually the same as indent_columns or indent_switch_case.</source>
        ...
        <translation>Пробелы для отступа тела `switch` перед любым `case`.
...
It might be wise to choose the same value for the option indent_switch_case.</source>
        ...
        <translation>Пробел для отступа `{` от `case`. По умолчанию скобка будет отображаться под буквой `c` в `case`. 
...
Возможно, имеет смысл выбрать такое же значение для параметра `indent_switch_case`.</translation>
    ...
    <message>
        ...
        <translation>Отступ `break` от `switch`
    ...
    <message>
        ...
        <translation>Добавить отступы для препроцессорных утверждений внутри утверждений switch.</translation>
    </message>
    <message>
...
Usually 0.</source>
        ...
        <translation>Пробел для сдвига строки `case`, не затрагивая другие строки.
...
Обычно 0.
    ...
    <message>
        ...
        <translation>Выравнивать комментарии перед &apos;case&apos; по &apos;case&apos;.</translation>
    </message>
    <message>
        ...
        <translation>Делать отступ для комментариев, не найденных в первой колонке.</translation>
    </message>
    <message>
        ...
        <translation>Отступы для  комментариев, найденных в первой колонке.
    ...
    <message>
        ...
        <translation>Делать отступ в первой колонке в многострочном литерале.</translation>
    </message>
    <message>
        ...
        <translation>Лимит столбцов для выравнивания комментариев на соседних строках</translation>
    </message>
    <message>
        ...
        <translation>Игнорировать отступ для меток goto.</translation>
    </message>
    <message>
...
&lt;=0: Subtract from brace indent</source>
        <comment>indent_label</comment>
        <translation>- =0: Абсолютный столбец, где 1 - самый левый столбец
...
colon.</source>
        ...
        <translation>Отступы для спецификаторов доступа, за которыми следует двоеточие.
...
If true, this option forces &apos;indent_access_spec=0&apos;.</source>
        ...
        <translation>Добавить отступ кода после спецификатора доступа на один уровень.
...
line so that it lines up after the open parenthesis (not recommended).</source>
        ...
        <translation>Если за открывающей круглой скобкой следует новая строка, добавлять отступ на следующей строке так, чтобы она начиналась после открывающей круглой скобки (не рекомендуется).
    ...
    <message>
        ...
        <translation>Отступ от ближайшей скобки после новой строки.
...
if the parenthesis is on its own line.</source>
        ...
        <translation>Делать отступ от открывающей скобки определения функции, если скобка находится на отдельной строке.</translation>
    </message>
    <message>
...
if the parenthesis is on its own line.</source>
        ...
        <translation>Нужно ли делать отступ от открывающей скобки объявления функции, если скобка находится на отдельной строке.
...
if the parenthesis is on its own line.</source>
        ...
        <translation>Делать отступ от открывающей скобки вызова функции, если скобка находится на отдельной строке.</translation>
    </message>
    <message>
...
If true, aligns under the open for parenthesis.</source>
        ...
        <translation>Нужно ли делать отступ для точки с запятой внутри скобки for.

Если true, то выравнивается под открывающей круглой скобкой.</translation>
    </message>
    <message>
...
if indent_semicolon_for_paren=true.</source>
        ...
        <translation>Выравнивать первое выражение по последующим, если `indent_semicolon_for_paren=true`.</translation>
    </message>
    <message>
...
so that it lines up after the open square (not recommended).</source>
        ...
        <translation>Если за открывающей фигурной скобкой следует новая строка, добавлять отступ на следующей строке так, чтобы она начиналась после открывающей фигурной скобки (не рекомендуется).</translation>
    </message>
    <message>
        ...
        <translation>(ESQL/C) Сохранить относительный отступ &apos;EXEC SQL&apos;.</translation>
    </message>
    <message>
...
followed by a newline, the next line is indent one tab.</source>
        ...
        <translation>Выравнивать разорванные утверждения по &apos;=&apos;. 

Если false или если за &apos;=&apos; следует новая строка, отступ следующей строки составляет одну табуляцию.</translation>
    </message>
    <message>
...
LHS token indentation column before &apos;=&apos;.</source>
        ...
        <translation>Если true, то отступ фрагментов после последовательности &apos;=&apos; будет устанавливаться по адресу LHS столбца отступа лексемы перед &apos;=&apos;.</translation>
    </message>
    <message>
...
Если false или за `(` следует новая строка, отступ следующей строки составляет одну табуляцию.</translation>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="12024"/>
...
rules.</source>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="12030"/>
...
&gt;0: Use specified number of spaces to indent</source>
        <comment>indent_oc_block_msg</comment>
        <translation>- =0: Использовать правила `indent_oc_block`
- &gt;0: Использовать заданное количество пробелов для отступа</translation>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="12042"/>
...
previous indentation level). Requires indent_oc_block_msg=true.</source>
        ...
        <translation>(OC) Отступ для блоков так, как это делает Xcode по умолчанию (от ключевого слова, если параметр находится на своей строке; в противном случае - от предыдущего уровня отступа).

Требуется, чтобы `indent_oc_block_msg=true`.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="12054"/>
...
message keyword. Requires indent_oc_block_msg=true.</source>
        ...
        <translation>(OC) Отступ блоков от места расположения скобки относительно ключевого слова сообщения.

Требуется, чтобы `indent_oc_block_msg=true`.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="12060"/>
...
colon. Requires indent_oc_block_msg=true.</source>
        ...
        <translation>(OC) Отступ блоков от места скобки относительно двоеточия сообщения. 
...
Requires indent_oc_block_msg=true.</source>
        ...
        <translation>(OC) Отступ блока от места, где находится обводка блока.

Требуется, чтобы `indent_oc_block_msg=true`.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="12072"/>
        <source>(OC) Whether to indent blocks from where the brace caret is.
Requires indent_oc_block_msg=true.</source>
        <comment>indent_oc_block_msg_from_brace</comment>
        <translation>(OC) Отступ блока от места, где находится скобка.
...
reach this minimum indent.</source>
        ...
        <translation>При отступе после открывающей виртуальной скобки и новой строки добавить дополнительные пробелы, чтобы достичь этого минимального отступа.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="12084"/>
...
when indenting after virtual brace open and newline.</source>
        ...
        <translation>Добавить дополнительные пробелы после обычного отступа для достижения следующего tabstop при отступе после открывающей виртуальной скобки и новой строки.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="12090"/>
...
- false: отступ от всех содержащихся строк, чтобы соответствовать скобке.</translation>
    ...
    <message>
        ...
        <translation>Добавить отступы в теле лямбды C++11.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="12102"/>
...
- true: добавить отступ от возврата и открывающей скобки составного литерала (т.е. 2 уровня отступа) 
- false: только 1 уровень отступа, не добавлять отступ для открывающей скобки, добавить отступ только для возврата.</translation>
    </message>
    <message>
        ...
        <translation>(C#) Добавить отступы блока `using`, если не используются скобки.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="12114"/>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="12120"/>
        <source>Whether to indent the statements inside ternary operator.</source>
        <comment>indent_inside_ternary_operator</comment>
        <translation>Отступы для утверждений внутри тернарного оператора.</translation>
    </message>
    <message>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="12132"/>
    ...
    <message>
        ...
        <translation>Если `true`, то лексемы после `return` будут иметь обычный одинарный отступ. 

По умолчанию (`false`) отступ делается относительно лексемы `return`.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="12144"/>
...
have their own indentation).</source>
        ...
        <translation>Игнорировать отступ и выравнивание для блоков `asm` (т.е. считать, что они имеют свой собственный отступ).</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="12150"/>
        <source>Don&apos;t indent the close parenthesis of a function definition,
if the parenthesis is on its own line.</source>
        <comment>donot_indent_func_def_close_paren</comment>
        <translation>Не делать отступ для закрывающей скобки определения функции, если скобка находится на отдельной строке.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="12170"/>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="12182"/>
    ...
    <message>
        ...
        <translation>Не разбивать однострочные функции get/set.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="12194"/>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="12200"/>
...
Может модифицировать `nl_func_type_name`</translation>
    ...
    <message>
        ...
        <translation>Не разбивать однострочные лямбды C++11, как в `[]() { return 0; }`.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="12212"/>
    ...
    <message>
        ...
        <translation>Не разбивать однострочные операторы `while`</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="12224"/>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="12230"/>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="12242"/>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="12254"/>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="12260"/>
    ...
    <message>
        ...
        <translation>Добавить или убрать новые строки в начале файла.</translation>
    </message>
    <message>
...
nl_start_of_file is &apos;add&apos; or &apos;force&apos;).</source>
        ...
        <translation>Минимальное количество новых строк в начале файла (используется только если `nl_start_of_file` имеет значение `add` или `force`).</translation>
    </message>
    <message>
        ...
        <translation>Добавить или убрать новые строки в конце файла.</translation>
    </message>
    <message>
...
nl_end_of_file is &apos;add&apos; or &apos;force&apos;).</source>
        ...
        <translation>Минимальное количество новых строк в конце файла (используется только если `nl_end_of_file` имеет значение `add` или `force`).</translation>
    </message>
    <message>
        ...
        <translation>Добавить или убрать новую строку между `=` и `{`.</translation>
    </message>
    <message>
...
&apos;list_for_each(item, &amp;list) { }&apos;.</source>
        ...
        <translation>Добавить или удалить новую строку между `)` и `{` в вызове функции, как в примере `list_for_each(item, &amp;list)¶ { }`.</translation>
    </message>
    <message>
        ...
        <translation>Добавить или убрать новую строку между `enum` и `{`.</translation>
    </message>
    <message>
        ...
        <translation>Добавить или убрать новую строку между `enum` и `class`.</translation>
    </message>
    <message>
        ...
        <translation>Добавить или убрать новую строку между `enum class` и идентификатором.</translation>
    </message>
    <message>
        ...
        <translation>Добавить или убрать новую строку между `enum class` и двоеточием перед типом.</translation>
    </message>
    <message>
        ...
        <translation>Добавить или убрать новую строку между `enum class identifier :` и типом.</translation>
    </message>
    <message>
        ...
        <translation>Добавить или убрать новую строку между `struct` и `{`.</translation>
    </message>
    <message>
        ...
        <translation>Добавить или убрать новую строку между `union` и `{`.</translation>
    </message>
    <message>
        ...
        <translation>Добавить или убрать новую строку между `if` и `{`.</translation>
    </message>
    <message>
        ...
        <translation>Добавить или убрать новую строку между `}` и `else`.</translation>
    </message>
    <message>
...
nl_if_brace is used instead.</source>
        ...
        <translation>Добавить или удалить новую строку между `else if` и `{`. 

Если установлено значение `ignore`, вместо него используется `nl_if_brace`.</translation>
    </message>
    <message>
        ...
        <translation>Добавить или убрать новую строку между `else` и `{`.</translation>
    </message>
    <message>
        ...
        <translation>Добавить или убрать новую строку между `else` и `if`.</translation>
    </message>
    <message>
        ...
        <translation>Добавить или убрать новую строку перед открывающейся фигурной скобкой `{`</translation>
    </message>
    <message>
        ...
        <translation>Добавить или убрать новую строку перед закрывающей круглой скобкой `if`/`else if`.</translation>
    </message>
    <message>
        ...
        <translation>Добавить или убрать новую строку между `}` и `finally`.</translation>
    </message>
    <message>
        ...
        <translation>Добавить или убрать новую строку между `finally` и `}`.</translation>
    </message>
    <message>
        ...
        <translation>Добавить или убрать новую строку между `try` и `{`.</translation>
    </message>
    <message>
        ...
        <translation>Добавить или убрать новую строку между get/set и `{`.</translation>
    </message>
    <message>
        ...
        <translation>Добавить или убрать новую строку между `for` и `{`.</translation>
    </message>
    <message>
...
&apos;catch (decl) &lt;here&gt; {&apos;.</source>
        ...
        <translation>Добавить или удалить новую строку перед `{` оператора `catch`, как в примере
&apos;catch (decl) ¶ {&apos;.</translation>
    </message>
    <message>
...
&apos;@catch (decl) &lt;here&gt; {&apos;. If set to ignore, nl_catch_brace is used.</source>
        ...
        <translation>(OC) Добавить или удалить новую строку перед `{` оператора `@catch`, как в `@catch (decl) ¶ {`. 

Если установлено значение игнорировать, используется `nl_catch_brace`.</translation>
    </message>
    <message>
        ...
        <translation>Добавить или убрать новую строку между `}` и `catch`.</translation>
    </message>
    <message>
...
nl_brace_catch is used.</source>
        ...
        <translation>(OC) Добавить или убрать новую строку между &apos;}&apos; и &apos;@catch&apos;. 
...
Если установлено `ignore`, используется `nl_brace_catch`.</translation>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="12482"/>
        <source>Add or remove newline between &apos;}&apos; and &apos;)&apos; in a function invocation.</source>
        <comment>nl_brace_fparen</comment>
        <translation>Добавить или убрать новую строку между `}` и `)` при вызове функции.</translation>
    </message>
    <message>
        ...
        <translation>Добавить или убрать новую строку между `while` и `{`.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="12494"/>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="12512"/>
...
newline/brace handling, REMOVE may not work.</source>
        ...
        <translation>Добавить или удалить новую строку между двумя закрывающими или открывающими фигурными скобками. Из-за общей работы с новой строкой и скобками, REMOVE может не сработать.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="12524"/>
        <source>Add or remove newline between &apos;do&apos; and &apos;{&apos;.</source>
        <comment>nl_do_brace</comment>
        <translation>Добавить или убрать новую строку между `do` и `{`.</translation>
    </message>
    <message>
        ...
        <translation>Добавить или убрать пробел между `}` и `while` в конструкции `do`.</translation>
    </message>
    <message>
        ...
        <translation>Добавить или убрать новую строку между `switch` и `{`.</translation>
    </message>
    <message>
        ...
        <translation>(D) Добавить или убрать новую строку между `synchronized` и `{`.</translation>
    </message>
    <message>
...
if/for/etc.</source>
        ...
        <translation>Добавить новую строку между `)` и `{`, если `)` находится на другой строке, чем if/for/etc.
...
lines</source>
        ...
        <translation>Добавить новую строку после `(`, если условие `if`/`for`/`while`/`switch` охватывает несколько строк
...
lines. Overrides nl_before_if_closing_paren if both are specified.</source>
        ...
        <translation>Добавить новую строку перед `)`, если условие `if`/`for`/`while`/`switch` охватывает несколько строк. 
...
Отменяет `nl_before_if_closing_paren`, если указаны оба.
    ...
    <message>
        ...
        <translation>Принудительное добавление новой строки для многострочного определения макроса после объявления
...
statement that follows a &apos;;&apos; or &apos;}&apos;.</source>
        ...
        <translation>Добавить новую строку перед `case` и пустую строку перед `case`, который следует за `;` или `}`.
    ...
    <message>
        ...
        <translation>Добавить или убрать пустую строку после оператора `case`.</translation>
    </message>
    <message>
        ...
        <translation>Добавить или убрать новую строку между `:` и `{` в `case`.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="12584"/>
    ...
    <message>
        ...
        <translation>Добавить или убрать новую строку между `)` и `throw`</translation>
    </message>
    <message>
        ...
        <translation>Добавить или убрать новую строку между `namespace` и `}`.</translation>
    </message>
    <message>
        ...
        <translation>Добавить или убрать новую строку после `template&lt;...&gt;` в шаблоне класса.

    template &lt;class T&gt;¶struct type1;
    template &lt;int&gt;¶struct type2 {</translation>
    </message>
    <message>
        ...
        <translation>Добавить или убрать новую строку после `template&lt;...&gt;` в объявлении класса.

    template &lt;class T&gt;¶struct type;</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="12608"/>
    ...
    <message>
        ...
        <translation>Добавить или убрать новую строку после `template&lt;...&gt;` в объявлении специализации класса.

    template &lt;int&gt;¶struct type;</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="12614"/>
    ...
    <message>
        ...
        <translation>Добавить или убрать новую строку после `template&lt;...&gt;` в определении класса.
    ...
    <message>
        ...
        <translation>Добавить или убрать новую строку после `template&lt;...&gt;` в определении специализации класса.
    ...
    <message>
        ...
        <translation>Добавить или убрать новую строку после `template&lt;...&gt;` в шаблоне функции.

    template &lt;class T&gt;¶T fun1(T x);
    template &lt;int&gt;¶T fun2(T x){</translation>
    </message>
    <message>
...
declaration.</source>
        ...
        <translation>Добавить или убрать новую строку после `template&lt;...&gt;` в объявлении шаблонной функции.

    template &lt;class T&gt;¶T fun(T x);</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="12638"/>
...
declaration.</source>
        ...
        <translation>Добавить или убрать новую строку после `template&lt;...&gt;` в специализированном определении шаблонной функции.

    template &lt;double&gt;¶double fun(double x);</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="12644"/>
...
definition.</source>
        ...
        <translation>Добавить или убрать новую строку после `template&lt;...&gt;` в реализации шаблонной функции.
...
definition.</source>
        ...
        <translation>Добавить или убрать новую строку после `template&lt;...&gt;` в специализированной реализации шаблонной функции.
    ...
    <message>
        ...
        <translation>Добавить или убрать новую строку после `template&lt;...&gt;` в шаблонной переменной.

    template &lt;class T&gt; ¶pi=T(M_PI);</translation>
    </message>
    <message>
...
type alias.</source>
        ...
        <translation>Добавить или убрать новую строку между `template&lt;...&gt;` и using в алиасе типа.

    template&lt;class T&gt;¶using Vec = vector&lt;T, Alloc&lt;T&gt; &gt;;</translation>
    </message>
    <message>
        ...
        <translation>Добавить или убрать новую строку между `class` и `{`.

    class X : public Mixins ... ¶{</translation>
    </message>
    <message>
...
may not be IGNORE) each&apos;,&apos; in the base class list.</source>
        ...
        <translation>Добавить или удалить новую строку до или после (в зависимости от `pos_class_comma`, который не может быть IGNORE) каждой запятой `,` в списке базовых классов.

    class MyClass : public Foo,¶private Bar {</translation>
    </message>
    <message>
...
pos_constr_comma.</source>
        ...
        <translation>Добавить или удалить новую строку после каждой запятой `,` в списке инициализаторов членов конструктора.

Связано с `nl_constr_colon`, `pos_constr_colon` и `pos_constr_comma`.

    MyClass(int a, int b, int c)
	: m_a(a),¶ m_b(b),¶ m_c(c) {</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="12692"/>
...
element, in &apos;enum&apos;.</source>
        ...
        <translation>Добавить или удалить новую строку перед первым элементом, после запятой и после последнего элемента `enum`
...
might be modified by nl_func_leave_one_liners</source>
        ...
        <translation>Добавить или удалить новую строку между возвращаемым типом и именем функции в определении функции.

может быть модифицирован командой `nl_func_leave_one_liners`

    double¶f(double x){return x;}</translation>
    </message>
    <message>
...
is used instead.</source>
        ...
        <translation>Добавить или удалить новую строку между возвращаемым типом и именем функции в функции внутри определения класса.
...
not appear with in-line implementation).</source>
        ...
        <translation>Добавить или удалить новую строку между спецификацией класса и `::` в `void A¶::f() { }`. 

Появляется только в реализации отдельного члена (не появляется при встроенной реализации).</translation>
    </message>
    <message>
...
&apos;void A :: &lt;here&gt; f() { }&apos;.</source>
        ...
        <translation>Добавить или удалить новую строку между областью действия функции и ее именем

    void A::¶f() { }</translation>
    </message>
    <message>
        ...
        <translation>Добавить или убрать новую строку между типом возврата и именем функции в объявлении.

    void ¶Function();</translation>
    </message>
    <message>
...
declaration.</source>
        ...
        <translation>Добавить или убрать новую строку между именем функции и открывающей скобкой списка параметров в объявлении.

    void Function¶(double x);</translation>
    </message>
    <message>
        ...
        <translation>Переопределяет `nl_func_paren` для функций без параметров.
...
definition.</source>
        ...
        <translation>Добавить или убрать новую строку между именем функции и открывающей скобкой списка параметров в определении.

    void Function¶(double x){return x;}</translation>
    </message>
    <message>
...
call.</source>
        ...
        <translation>Добавить или убрать новую строку между именем функции и открывающей скобкой списка параметров в вызове.
    ...
    <message>
        ...
        <translation>Добавить или убрать новую строку после `(` в объявлении функции.
    ...
    <message>
        ...
        <translation>Добавить или убрать новую строку после `(` в определении функции.
...
are in different lines. If false, nl_func_decl_start is used instead.</source>
        ...
        <translation>Добавить новую строку после `(` в объявлении функции, если `(` и `)` находятся в разных строках. 

Если `false`, то вместо этого используется `nl_func_decl_start`.</translation>
    </message>
    <message>
...
are in different lines. If false, nl_func_def_start is used instead.</source>
        ...
        <translation>Добавить новую строку после `(` в определении функции, если `(` и `)` находятся в разных строках. 

Если `false`, то вместо этого используется `nl_func_def_start`.</translation>
    </message>
    <message>
        ...
        <translation>Добавить или убрать новую строку после каждой `,` в объявлении функции.</translation>
    </message>
    <message>
        ...
        <translation>Добавить или убрать новую строку после каждой `,` в определении функции.</translation>
    </message>
    <message>
        ...
        <translation>Добавить или убрать новую строку после каждой `,` в вызове функции.</translation>
    </message>
    <message>
...
and &apos;)&apos; are in different lines. If false, nl_func_decl_args is used instead.</source>
        ...
        <translation>Добавить новую строку после каждой запятой `,` в объявлении функции, если `(` и `)` находятся в разных строках. 

Если `false`, то вместо этого используется `nl_func_decl_args`.</translation>
    </message>
    <message>
...
and &apos;)&apos; are in different lines. If false, nl_func_def_args is used instead.</source>
        ...
        <translation>Добавить новую строку после каждой запятой `,` в определении функции, если `(` и `)` находятся в разных строках. 

Если `false`, то вместо этого используется `nl_func_def_args`.</translation>
    </message>
    <message>
        ...
        <translation>Добавить или убрать новую строку перед символом `)` в объявлении функции.</translation>
    </message>
    <message>
        ...
        <translation>Добавить или убрать новую строку перед символом `)` в определении функции.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="12842"/>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="12854"/>
...
are in different lines. If false, nl_func_decl_end is used instead.</source>
        ...
        <translation>Добавить новую строку перед скобкой `)` в объявлении функции, если `(` и `)` находятся в разных строках. 

Если `false`, то вместо этого используется `nl_func_decl_end`.</translation>
    </message>
    <message>
...
are in different lines. If false, nl_func_def_end is used instead.</source>
        ...
        <translation>Добавить новую строку перед скобкой `)` в определении функции, если `(` и `)` находятся в разных строках. 

Если `false`, то вместо этого используется `nl_func_def_end`.</translation>
    </message>
    <message>
        ...
        <translation>Добавить или убрать новую строку между `()` в объявлении функции.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="12872"/>
        <source>Add or remove newline between &apos;()&apos; in a function definition.</source>
        <comment>nl_func_def_empty</comment>
        <translation>Добавить или убрать новую строку между `()` в определении функции.</translation>
    </message>
    <message>
        ...
        <translation>Добавить или убрать новую строку между `()` при вызове функции.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="12884"/>
...
has preference over nl_func_call_start_multi_line.</source>
        ...
        <translation>Добавить новую строку после `(` в вызове функции, имеет проритет над `nl_func_call_start_multi_line`.</translation>
    </message>
    <message>
        ...
        <translation>Добавить новую строку перед `)` при вызове функции.</translation>
    </message>
    <message>
...
different lines.</source>
        ...
        <translation>Добавить новую строку после `(` в вызове функции, если скобки расположены на разных строках</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="12902"/>
...
are in different lines.</source>
        ...
        <translation>Добавить новую строку после каждой запятой в списке параметров вызова функции, если скобки расположены на разных строках.</translation>
    </message>
    <message>
...
different lines.</source>
        ...
        <translation>Добавить новую строку перед `)` в вызове функции, если скобки расположены на разных строках</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="12914"/>
        ...
        <translation>Соблюдать опцию `nl_func_call_XXX` в случае аргументов замыкания.</translation>
    </message>
    <message>
        ...
        <translation>Добавить новую строку после `&lt;` в списке параметров шаблона.

    template&lt;¶class A, class B&gt; struct test;</translation>
    </message>
    <message>
        ...
        <translation>Добавить новую строку после каждой запятой в списке параметров шаблона.

    template&lt;class A,¶ class B,¶ class C&gt; struct test;</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="12932"/>
        <source>Whether to add a newline before &apos;&gt;&apos; of a template parameter list.</source>
        <comment>nl_template_end</comment>
        <translation>Добавить новую строку перед `&gt;` в списке параметров шаблона.
...
See nl_oc_msg_leave_one_liner.</source>
        ...
        <translation>(OC) Помещать каждый параметр сообщения Objective-C в отдельную строку.

См. `nl_oc_msg_leave_one_liner`</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="12962"/>
        <source>Add or remove newline between function signature and &apos;{&apos;.</source>
        <comment>nl_fdef_brace</comment>
        <translation>Добавить или убрать новую строку между сигнатурой функции и `{`.

    double f(double x)¶{return x;}
    double f(double x)const ¶{return x;}</translation>
    </message>
    <message>
...
if signature ends with &apos;)&apos;. Overrides nl_fdef_brace.</source>
        ...
        <translation>Добавить или убрать новую строку между сигнатурой функции и `{`, если сигнатура заканчивается скобкой.
...
Переопределяет `nl_fdef_brace`.
    ...
    <message>
        <location filename="uncrustify_ui.py" line="12974"/>
        <source>Add or remove newline between C++11 lambda signature and &apos;{&apos;.</source>
        <comment>nl_cpp_ldef_brace</comment>
        <translation>Добавить или убрать новую строку между лямбда-сигнатурой C++11 и `{`.

    [=](double x)¶{return x;}</translation>
    </message>
    <message>
        ...
        <translation>Добавить или убрать новую строку между `return` и выражением return.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="12992"/>
        <source>Whether to add a newline after semicolons, except in &apos;for&apos; statements.</source>
        <comment>nl_after_semicolon</comment>
        <translation>Добавить новую строку после точки с запятой, кроме как в утверждении `for`.</translation>
    </message>
    <message>
...
direct-list-initialization.</source>
        ...
        <translation>Добавлять ли новую строку после открывающей скобки в неименованном временном прямом списке инициализации.</translation>
    </message>
    <message>
...
direct-list-initialization.</source>
        ...
        <translation>Добавлять ли новую строку перед закрывающей скобкой в неименованном временном прямом списке инициализации.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="13022"/>
        <source>Whether to add a newline before &apos;{&apos;.</source>
        <comment>nl_before_brace_open</comment>
        <translation>Добавить новую строку перед `{`.</translation>
    </message>
    <message>
        ...
        <translation>Добавить новую строку после `{`.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="13034"/>
...
comment. Requires nl_after_brace_open=true.</source>
        ...
        <translation>Добавить новую строку между открытой скобкой и завершающим однострочным комментарием. 
Требуется `nl_after_brace_open=true`</translation>
    </message>
    <message>
...
These occur in un-braced if/while/do/for statement bodies.</source>
        ...
        <translation>Добавить новую строку после виртуальной скобки, открытой с непустым телом.

Это происходит в телах операторов `if`/`while`/`do`/`for` без скобок.

    if(x&lt;0)¶ x=-x;</translation>
    </message>
    <message>
...
These occur in un-braced if/while/do/for statement bodies.</source>
        ...
        <translation>Добавить новую строку после виртуальной скобки, открытой с пустым телом.

Это происходит в телах операторов `if`/`while`/`do`/`for` без скобок.

    while(process())¶;</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="13052"/>
        <source>Whether to add a newline after &apos;}&apos;. Does not apply if followed by a
necessary &apos;;&apos;.</source>
        <comment>nl_after_brace_close</comment>
        <translation>Добавить новую строку после `}`. Не применяется, если за ним следует необходимая `;`.</translation>
    </message>
    <message>
...
as in &apos;if (foo) a++; &lt;here&gt; return;&apos;.</source>
        ...
        <translation>Добавить новую строку после закрытия виртуальной скобки, как в `if (foo) a++;¶return;`.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="13064"/>
...
structures. If set to ignore, uses nl_after_brace_close.</source>
        ...
        <translation>Добавить или удалить новую строку между закрывающей скобкой и идентификатором, как в `struct { int a; } ¶ b;`. 
Действует на перечисления, объединения и структуры. 
Если установлено значение `ignore`, используется `nl_after_brace_close`.</translation>
    </message>
    <message>
...
lines.</source>
        ...
        <translation>Добавлять новые строки между последовательными закрывающими скобками. Количество закрывающих круглых скобок в строке будет зависеть от соответствующих открытых скобок.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="13082"/>
...
&apos;#endif&apos;. Does not affect top-level #ifdefs.</source>
        ...
        <translation>Удалять пробелы после &apos;#ifxx&apos; и &apos;#elxx&apos;, или перед &apos;#elxx&apos; и &apos;#endif&apos;. Не влияет на #ifdef верхнего уровня.</translation>
    </message>
    <message>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="13094"/>
        <source>Add or remove blank line before &apos;if&apos;.</source>
        <comment>nl_before_if</comment>
        <translation>Добавить или убрать пустую строку перед `if`.

    ¶if(x!=y)x=y;</translation>
    </message>
    <message>
...
next token is not a closing brace.</source>
        ...
        <translation>Добавить или убрать пустую строку после оператора `if`. 

    if(x!=y)x=y;¶

`Add`/`Force` работает только в том случае, если следующая лексема не является закрывающей скобкой.</translation>
    </message>
    <message>
        ...
        <translation>Добавить или убрать пустую строку перед `for`.

    ¶for(int i=0; i!=10;i++){...}</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="13112"/>
        <source>Add or remove blank line after &apos;for&apos; statement.</source>
        <comment>nl_after_for</comment>
        <translation>Добавить или убрать пустую строку после оператора `for`.
    ...
    <message>
        ...
        <translation>Добавить или убрать пустую строку перед `while`.

    ¶while(i!=10){i++;}</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="13124"/>
        <source>Add or remove blank line after &apos;while&apos; statement.</source>
        <comment>nl_after_while</comment>
        <translation>Добавить или убрать пустую строку после оператора `while`.
    ...
    <message>
        ...
        <translation>Добавить или убрать пустую строку перед `switch`.

    ¶switch(i){...}</translation>
    </message>
    <message>
        ...
        <translation>Добавить или убрать пустую строку после оператора `switch`.

    switch(i){...}¶</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="13142"/>
        <source>Add or remove blank line before &apos;synchronized&apos;.</source>
        <comment>nl_before_synchronized</comment>
        <translation>Добавить или убрать пустую строку перед `synchronized`</translation>
    </message>
    <message>
        ...
        <translation>Добавить или убрать пустую строку после оператора `synchronized`.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="13154"/>
        <source>Add or remove blank line before &apos;do&apos;.</source>
        <comment>nl_before_do</comment>
        <translation>Добавить или убрать пустую строку перед `do`.

    ¶do{i++;}while(i!=10);</translation>
    </message>
    <message>
        ...
        <translation>Добавить или убрать пустую строку после оператора `do/while`.
...
does nothing.</source>
        ...
        <translation>Игнорировать `nl_before_{if,for,switch,do,synchronized}`, если управляющий оператор находится сразу после оператора `case`.

Если для параметра `nl_before_{if,for,switch,do}` установлено значение `remove`, этот параметр ничего не делает.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="13172"/>
        <source>Whether to put a blank line before &apos;return&apos; statements, unless after an open
brace.</source>
        <comment>nl_before_return</comment>
        <translation>Добавить пустую строку перед значением &apos;return&apos;, если не после открывающей скобки.

    x=5;¶return 3;</translation>
    </message>
    <message>
...
close brace.</source>
        ...
        <translation>Ставить ли пустую строку после оператора &apos;return&apos;, если за ним не следует закрывающая скобка.

    return 3;¶</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="13184"/>
    ...
    <message>
        ...
        <translation>(Java) Добавить пустую строку после операторов `.` или `-&gt;`.</translation>
    </message>
    <message>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="13202"/>
...
colon, as in &apos;class Foo &lt;here&gt; : &lt;or here&gt; public Bar&apos;.</source>
        ...
        <translation>Добавить или удалить новую строку до или после (в зависимости от `pos_class_colon`, который не может быть IGNORE) двоеточия в списке базовых классов.

    class MyClass :¶ public Foo, private Bar {</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="13214"/>
...
depends on nl_constr_init_args, pos_constr_colon and pos_constr_comma.</source>
        ...
        <translation>Добавить или удалить новую строку вокруг двоеточия конструктора класса. Точное положение зависит от `nl_constr_init_args`, `pos_constr_colon` и `pos_constr_comma`.</translation>
    </message>
    <message>
...
such code into four lines. If true, it also preserves one-liner namespaces.</source>
        ...
        <translation>Следует ли свернуть двухстрочное пространство имен, например, &apos;namespace foo¶{ decl; }&apos; в одну строку. 

Если `true`, то предотвращает превращение такого кода в четыре строки другими правилами переноса строк. 
Если `true`, то также сохраняет однострочные пространства имен.</translation>
    </message>
    <message>
...
into one-liners, as in &apos;if(b)\n i++;&apos; =&gt; &apos;if(b) i++;&apos;.</source>
        ...
        <translation>Удалять ли новую строку в простых бесскобочных операторах `if`, превращая их в однострочные

    if(b)¶ i++</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="13232"/>
...
в однострочные
    ...
    <message>
        <location filename="uncrustify_ui.py" line="13244"/>
...
adding newlines, as in &apos;int a[12] = { &lt;here&gt; 0 &lt;here&gt; };&apos;.</source>
        ...
        <translation>Следует ли разбивать однострочные определения простых списков на три строки путем добавлением новых строк, как в `int a[12] = { ¶ 0 ¶ };`.</translation>
    </message>
    <message>
...
adding a newline, as in &apos;if(b) &lt;here&gt; i++;&apos;.</source>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="13262"/>
...
adding a newline, as in &apos;while (expr) &lt;here&gt; stmt;&apos;.</source>
        ...
        <translation>Разбивать однострочные простые операторы while без скобок на две строки путем добавлением новой строки

    `while (expr) ¶ stmt;`</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="13274"/>
...
call.</source>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="13282"/>
    ...
    <message>
        ...
        <translation>Количество пустых строк перед прототипом функции.</translation>
    </message>
    <message>
...
applicable, this option is overridden with eat_blanks_after_open_brace=true</source>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="13312"/>
        ...
        <translation>Количество пустых строк перед прототипом конструктора/деструктора.</translation>
    </message>
    <message>
        ...
        <translation>Количество пустых строк перед определением конструктора/деструктора класса.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="13324"/>
        <source>The number of newlines after a function prototype.</source>
        <comment>nl_after_func_proto</comment>
        <translation>Количество пустых строк после прототипа функции.</translation>
    </message>
    <message>
...
another function prototype.</source>
    ...
    <message>
        ...
        <translation>Количество пустых строк после прототипа конструктора/деструктора класса.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="13342"/>
...
and nl_before_func_class_def for one-liners.</source>
        <comment>nl_class_leave_one_liner_groups</comment>
        <translation>Требуется `nl_class_leave_one_liners=true`
Отменяет `nl_before_func_body_def` и `nl_before_func_class_def` для однострочных символов.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="13354"/>
        <source>The number of newlines after &apos;}&apos; of a multi-line function body.</source>
        <comment>nl_after_func_body</comment>
        <translation>Количество пустых строк после финальной фигурной скобки `}` многострочного тела функции.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="13372"/>
...
affects class constructors/destructors.</source>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="13384"/>
...
ненулевое, этот параметр имеет приоритет.</translation>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="13414"/>
        <source>0: No change (default).</source>
...
Doesn&apos;t apply if after a brace open or another multi-line comment.</source>
        ...
        <translation>Минимальное количество новых строк перед многострочным комментарием.
Не применяется, после открывающей скобки или другого многострочного комментария.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="13432"/>
...
Doesn&apos;t apply if after a brace open or other single-line C comments.</source>
        ...
        <translation>Минимальное количество новых строк перед однострочным C-комментарием.
Не применяется, после открывающей скобки или другого однострочного комментария.</translation>
    </message>
    <message>
...
Doesn&apos;t apply if after a brace open or other CPP comments.</source>
        ...
        <translation>Минимальное количество новых строк перед CPP-комментарием.
Не применяется, после открывающей скобки или другого комментария.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="13444"/>
        <source>Whether to force a newline after a multi-line comment.</source>
        <comment>nl_after_multiline_comment</comment>
        <translation>Добавить новую строку после многострочного комментария.</translation>
    </message>
    <message>
        ...
        <translation>Добавить новую строку после двоеточия метки.</translation>
    </message>
    <message>
        ...
        <translation>Количество пустых строк перед определением структуры.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="13462"/>
        <source>The number of newlines after &apos;}&apos; or &apos;;&apos; of a struct/enum/union definition.</source>
        <comment>nl_after_struct</comment>
        <translation>Количество пустых строк после финальных `}` или `;` определения `struct`/`enum`/`union`.</translation>
    </message>
    <message>
        ...
        <translation>Количество пустых строк перед определением класса.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="13474"/>
        <source>The number of newlines after &apos;}&apos; or &apos;;&apos; of a class definition.</source>
        <comment>nl_after_class</comment>
        <translation>Количество пустых строк после финальных `}` или `;` определения класса.</translation>
    </message>
    <message>
        ...
        <translation>Количество пустых строк перед определением области имен.</translation>
    </message>
    <message>
...
before the matching &apos;}&apos;.</source>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="13492"/>
        <source>The number of newlines after &apos;}&apos; of a namespace.</source>
        <comment>nl_after_namespace</comment>
        <translation>Количество пустых строк после финальной фигурной скобки `}` пространства имён.</translation>
    </message>
    <message>
...
if after a brace open.</source>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="13504"/>
...
declaration.</source>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="13534"/>
    ...
    <message>
        ...
        <translation>Удалить пустые строки после `{`.</translation>
    </message>
    <message>
        ...
        <translation>Удалить пустые строки перед `}`.</translation>
    </message>
    <message>
        ...
        <translation>Насколько агрессивно удалять лишние строки не в препроцессоре.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="13552"/>
...
2: Remove all newlines and reformat completely by config</source>
        <comment>nl_remove_extra_newlines</comment>
        <translation>- 0: Без изменений (по умолчанию)
- 1: Удалить большинство новых строк, не обрабатываемых другими конфигурациями
- 2: Удалить все пустые строки и полностью переформатировать с помощью конфигурации</translation>
    </message>
    <message>
...
annotations that are after a newline.</source>
        ...
        <translation>(Java) Добавить или убрать новую строку после оператора аннотации.

Влияет только на аннотации, которые находятся после новой строки.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="13564"/>
    ...
    <message>
        ...
        <translation>Количество новых строк перед #ifdef файла.
...
См. include guards</translation>
    ...
    <message>
        ...
        <translation>Количество новых строк после #ifdef файла.
...
См. include guards</translation>
    ...
    <message>
        ...
        <translation>Количество новых строк перед #endif файла.
...
См. include guards</translation>
    ...
    <message>
        ...
        <translation>Количество новых строк после #endif файла.
...
См. include guards</translation>
    ...
    <message>
        ...
        <translation>Положение арифметических операторов при свертке выражений.</translation>
    </message>
    <message>
...
followed by &apos;{&apos;.</source>
        ...
        <translation>Позиция присваивания в свернутых выражениях. Не влияет на &apos;=&apos; за которым следует &apos;{&apos;.</translation>
    </message>
    <message>
        ...
        <translation>Положение логических операторов при свертке выражений.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="13614"/>
        <source>The position of comparison operators in wrapped expressions.</source>
        <comment>pos_compare</comment>
        <translation>Положение операторов сравнения при свертке выражений.</translation>
    </message>
    <message>
...
&apos;expr ? stmt : stmt&apos;, in wrapped expressions.</source>
        ...
        <translation>Положение условных операторов, как в символах `?` и &apos;:&apos; из выражения `expr ? stmt : stmt`, в свернутых выражениях.</translation>
    </message>
    <message>
        ...
        <translation>Положение запятой при свертке выражений.</translation>
    </message>
    <message>
...
line. Affects nl_class_init_args.</source>
        ...
        <translation>Положение запятой в списке базовых классов, если в нем более одной строк. Влияет на `nl_class_init_args`.</translation>
    </message>
    <message>
...
Related to nl_constr_colon, nl_constr_init_args and pos_constr_colon.</source>
        ...
        <translation>Позиция запятой в списке инициализации конструктора.

Связано с `nl_constr_colon`, `nl_constr_init_args` и `pos_constr_colon`.</translation>
    </message>
    <message>
...
Связано с `nl_constr_colon`, `nl_constr_init_args` и `pos_constr_comma`.</translation>
    ...
    <message>
        ...
        <translation>Положение операторов сдвига в свернутых выражениях.</translation>
    </message>
    <message>
...
Опция `ls_code_width` имеет приоритет над опцией `ls_func_split_full`.</translation>
    ...
    <message>
        ...
        <translation>Сохранять табуляции, не относящиеся к отступам.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Переходить при выравнивании на следующую позицию табуляции.</translation>
    </message>
    <message>
        ...
        <translation>Выравнивать цифры по правому краю.</translation>
    </message>
    <message>
        ...
        <translation>Сохранять пробелы ненужные для выравнивания.</translation>
    </message>
    <message>
        ...
        <translation>Выравнивать определения переменных в прототипах и функциях.</translation>
    </message>
    <message>
        ...
        <translation>Размах для выравнивания определений параметров в функции по имени параметра.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="13732"/>
...
Для абсолютных порогов используйте отрицательное число.</translation>
    ...
    <message>
        ...
        <translation>Зазор в выравнивании параметров функций в определении.</translation>
    </message>
    <message>
        ...
        <translation>Размах для выравнивания значений конструктора.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="13750"/>
        <source>0: Don&apos;t align (default).</source>
...
Для абсолютных порогов используйте отрицательное число.</translation>
    ...
    <message>
        ...
        <translation>Выравнивать двоеточие битовых полей.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Выравнивать любой атрибут после имени переменной.</translation>
    </message>
    <message>
        ...
        <translation>Выравнивать определения встроенных в struct/enum/union переменных.</translation>
    </message>
    <message>
        ...
        <translation>Размах для выравнивания по &apos;=&apos; в присваивании.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="13840"/>
        <source>0: Don&apos;t align (default).</source>
    ...
    <message>
        ...
        <translation>Размах для выравнивания по &apos;=&apos; в модификаторе прототипа функции.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="13846"/>
        <source>0: Don&apos;t align (default).</source>
...
Use a negative number for absolute thresholds.</source>
        ...
        <translation>Порог для выравнивания по &apos;=&apos; в присваивании.
Для абсолютных порогов используйте отрицательное число.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="13852"/>
...
&apos;virtual void foo() = 0&apos; or &apos;~foo() = {default|delete}&apos;.</source>
        ...
        <translation>Как применить `align_assign_span` к &quot;присвоениям&quot; объявлений функций, например, `virtual void foo() = 0` или `~foo() = {default|delete}`.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="13876"/>
...
2: Don&apos;t align</source>
        <comment>align_assign_decl_func</comment>
        <translation>- 0: Выравнивание по другим присваиваниям (по умолчанию)
...
- 2: Не выравнивать</translation>
    ...
    <message>
        ...
        <translation>Размах для выравнивания по &apos;=&apos; в перечислениях.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="13882"/>
        <source>0: Don&apos;t align (default).</source>
...
Use a negative number for absolute thresholds.</source>
        ...
        <translation>Порог для выравнивания по &apos;=&apos; в перечислениях.
Для абсолютных порогов используйте отрицательное число.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="13888"/>
    ...
    <message>
        ...
        <translation>Размах для выравнивания определений членов класса.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="13894"/>
        <source>0: Don&apos;t align (default).</source>
...
Use a negative number for absolute thresholds.</source>
        ...
        <translation>Порог для выравнивания определений членов класса.
Для абсолютных порогов используйте отрицательное число.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="13900"/>
    ...
    <message>
        ...
        <translation>Размах для выравнивания определений членов структуры/объединения.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="13912"/>
        <source>0: Don&apos;t align (default).</source>
...
Use a negative number for absolute thresholds.</source>
        ...
        <translation>Порог для выравнивания определений членов структур/объединений.
Для абсолютных порогов используйте отрицательное число.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="13918"/>
    ...
    <message>
        ...
        <translation>Размах для выравнивания значений инициализатора структуры.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="13930"/>
        <source>0: Don&apos;t align (default).</source>
    ...
    <message>
        ...
        <translation>Размах для выравнивания однострочных typedefs.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="13936"/>
        <source>0: Don&apos;t align (default).</source>
...
2: Align the function type name with the other type names</source>
        <comment>align_typedef_func</comment>
        <translation>- 0: Не смешивать их вообще (по умолчанию)
- 1: Выравнивание открывающей скобки по типам
- 2: Выравнивание имени типа функции по отношению к другим именам типов</translation>
    </message>
    <message>
...
Dangling: the &apos;*&apos; will not be taken into account when aligning.</source>
        <comment>align_typedef_star_style</comment>
        <translation>- 0: Часть типа typedef, `typedef int *········intref;` (по умолчанию)
...
Висячий: `&amp;` не будет учитываться при выравнивании.</translation>
    ...
    <message>
        ...
        <translation>Размах для выравнивания комментариев, завершающих строки.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="13966"/>
        <source>0: Don&apos;t align (default).</source>
...
an effect.</source>
        ...
        <translation>Минимальное количество колонок между предшествующим текстом и последующим комментарием для того. для того, чтобы комментарий был выровнен. Должно быть ненулевым, чтобы иметь эффект.</translation>
    </message>
    <message>
...
less than three spaces before the comment.</source>
    ...
    <message>
        ...
        <translation>Выравнивать только те замыкающие комментарии, которые находятся на одном и том же уровне скобки.</translation>
    </message>
    <message>
...
may be &quot;pulled in&quot;.</source>
        ...
        <translation>Минимальный столбец, по которому следует выравнивать отстающие комментарии. Комментарии, которые выровнены за пределами этого столбца, но которые могут быть выровнены в меньшем столбце, могут быть &quot;подтянуты&quot;.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="13990"/>
    ...
    <message>
        ...
        <translation>Размах для выравнивания прототипов функций.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="13996"/>
        <source>0: Don&apos;t align (default).</source>
...
Dangling: the &apos;*&apos; will not be taken into account when aligning.</source>
        <comment>align_func_proto_star_style</comment>
        <translation>- 0: Часть типа `long *·····foo();` (по умолчанию)
...
Use a negative number for absolute thresholds.</source>
        ...
        <translation>Порог для выравнивания прототипов функций.
Для абсолютных порогов используйте отрицательное число.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="14020"/>
    ...
    <message>
        ...
        <translation>Минимальный зазор между типом возврата и именем функции.</translation>
    </message>
    <message>
...
Требуется `align_single_line_func=true`. Используется `align_func_proto_span`.</translation>
    ...
    <message>
        ...
        <translation>Размах для выравнивания тела макросов #define.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="14086"/>
...
&gt;0: Number of lines (including comments) between blocks</source>
        <comment>align_pp_define_span</comment>
        <translation>- =0: Не выравнивать (по умолчанию)
- &gt;0: Количество строк (включая комментарии) между блоками</translation>
    ...
    <message>
        ...
        <translation>Выравнивать строки, начинающиеся с `&lt;&lt;` с предыдущим `&lt;&lt;`</translation>
    </message>
    <message>
...
on the &apos;:&apos;.</source>
    ...
    <message>
        ...
        <translation>Пытаться сворачивать комментарии на колонке N.</translation>
    </message>
    <message>
...
beg_of_next_line_regex[n] = &quot;^...&quot;</source>
        <comment>cmt_reflow_fold_regex_file</comment>
        <translation>end_of_prev_line_regex[1] = &quot;...$&quot;
beg_of_next_line_regex[1] = &quot;^...&quot;
end_of_prev_line_regex[2] = &quot;...$&quot;
beg_of_next_line_regex[2] = &quot;^...&quot;
            .
...
beg_of_next_line_regex[2] = &quot;^[A-Z]&quot;</source>
        <comment>cmt_reflow_fold_regex_file</comment>
        <translation>end_of_prev_line_regex[1] = &quot;[\w,\]\)]$&quot;
beg_of_next_line_regex[1] = &quot;^[\w,\[\(]&quot;
end_of_prev_line_regex[2] = &quot;\.$&quot;
beg_of_next_line_regex[2] = &quot;^[A-Z]&quot;</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="49"/>
        <source>Help page</source>
        <translation>Справочная страница</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="42"/>
        <source>Uncrustify</source>
        <translation>Uncrustify</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="42"/>
        <source>Code Overview</source>
        <translation>Обзор кода</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="42"/>
        <source>Step 1: Tokenize</source>
        <translation>Шаг 1. Токенизация</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="42"/>
        <source>The entire source file is read into a buffer and then it is parsed into what I call &apos;chunks&apos;.  These are the smallest lexical elements that form keywords, numbers, strings, identifiers, or punctuators.  The type of the chunk or token is as descriptive as needed and may depend on the language.</source>
        <translation>Весь исходный файл считывается в буфер, а затем он разбирается на то, что я называю &quot;кусками&quot;.  Это самые маленькие лексические элементы, которые образуют ключевые слова, числа, строки, идентификаторы или пунктуаторы.  Тип фрагмента или лексемы может быть настолько описательным, насколько это необходимо, и может зависеть от языка.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="42"/>
        <source>The following information is gathered on each chunk:
    ...
    • Flags (ie found in a preprocessor)</source>
        <translation>Для каждого куска собирается следующая информация:

-  Тип токена (полный список см. в src/c_token_enum.h)
-  Исходная строка и столбец
-  Длина (количество символов) фрагмента
-  подстрока
-  Был ли токен сразу после табуляции
-  Количество новых строк в строке (в основном для определения типа новой строки)
-  Флаги (т.е. найденные в препроцессоре)</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="42"/>
        <source>The chunk entry has other fields that get populated later.
    • The parent token type
    • Flags (see cparse_types.h for a complete list)
    • Output column
    • Brace Level (depth of open braces &apos;{&apos;)
    • Level (depth of braces, parenthesis, and square brackets)</source>
        <translation>Запись в чанке имеет другие поля, которые заполняются позже.

- Тип родительской лексемы
- Флаги (полный список см. в файле cparse_types.h)
- Колонка вывода
- Уровень скобок (глубина открытых скобок &apos;{&apos;)
- Уровень (глубина скобок, круглых скобок и квадратных скобок)</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="42"/>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="42"/>
        <source>Everything else is marked in this step, such as:
...
- Определяется назначение каждого двоеточия (метка, регистр, класс, ?: и т.д.)</translation>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="42"/>
        <source>This does all the aligning stuff.
...
- и т.д.</translation>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="42"/>
        <source>The only bit of complication is that multi-line comments are formatted in this step.</source>
        <translation>Единственная сложность заключается в том, что на этом шаге форматируются многострочные комментарии.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="9922"/>
        <source>Add or remove space in &apos;enum {&apos;.</source>
        <comment>sp_enum_brace</comment>
        <translation>Добавить или убрать пробел в &apos;enum {&apos;.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="10108"/>
        <source>Add or remove space between the pointer star &apos;*&apos; and the name of the type
in a function pointer type definition.</source>
        <comment>sp_ptr_star_func_type</comment>
        <translation>Добавить или убрать пробел между символом указателя `*` и именем типа в определении типа указателя функции.

    typedef void (*·foo)(void);</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="10174"/>
        <source>Add or remove space after a reference sign &apos;&amp;&apos;, if followed by an open
parenthesis, as in &apos;char&amp; (*)()&apos;.</source>
        <comment>sp_byref_paren</comment>
        <translation>Добавить или убрать пробел после знака ссылки &apos;&amp;&apos;, если за ним следует открывающая функция.

    char&amp;·(*)()</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="10492"/>
        <source>Add or remove space between a type and &apos;:&apos;.</source>
        <comment>sp_type_colon</comment>
        <translation>(C11) Добавить или убрать пробел между типом и `:`.

    #define IS_UNSIGNED(t) _Generic((t),  uint8_t·: true)</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="10498"/>
        <source>Add or remove space after the variadic &apos;...&apos; when preceded by a
non-punctuator.
The value REMOVE will be overridden with FORCE</source>
...
`switch(i){case 1...·2:`</translation>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="10504"/>
...
`switch(i){case 1·...2:`</translation>
    ...
    <message>
        ...
        <source>Add or remove space between two &apos;!&apos; (not) unary operators.
If set to ignore, sp_not will be used.</source>
        <comment>sp_not_not</comment>
        <translation>Добавляет или удаляет пробел между двумя унарными операторами &apos;!&apos;.
Если установлено значение ignore, будет использоваться sp_not.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="11466"/>
        <source>Whether to ignore indent for the first continuation line. Subsequent
continuation lines will still be indented to match the first.</source>
        <comment>indent_ignore_first_continue</comment>
        <translation>Следует ли игнорировать отступ для первой строки продолжения. Последующие строки продолжения будут иметь отступ, соответствующий первой.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="11472"/>
        <source>For FreeBSD, this is set to 4.
Requires indent_ignore_first_continue=false.</source>
        <comment>indent_continue</comment>
        <translation>Для FreeBSD это значение равно 4.
Требуется indent_ignore_first_continue=false.</translation>
    </message>
    <message>
...
Requires indent_ignore_first_continue=false.</source>
        ...
        <translation>Отступ продолжения, только для строки (строк) заголовка класса. Если значение ненулевое, это переопределяет отступ продолжения &apos;class&apos;.
Требуется indent_ignore_first_continue=false.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="11598"/>
        <source>Whether to indent only in inner namespaces (nested in other namespaces).
Requires indent_namespace=true.</source>
        <comment>indent_namespace_inner_only</comment>
        <translation>Делать ли отступ только во внутренних пространствах имен (вложенных в другие пространства имен).
Требуется indent_namespace=true.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="11616"/>
        <source>Whether to ignore indent for the leading base class colon.</source>
        <comment>indent_ignore_before_class_colon</comment>
        <translation>Следует ли игнорировать отступ для ведущего двоеточия базового класса.</translation>
    </message>
    <message>
...
the colon (see pos_class_colon and nl_class_colon)</source>
...
Требуется indent_ignore_before_class_colon=false и перенос строки перед двоеточием (см. pos_class_colon и nl_class_colon).</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="11640"/>
        <source>Whether to ignore indent for a leading class initializer colon.</source>
        <comment>indent_ignore_before_constr_colon</comment>
        <translation>Следует ли игнорировать отступ для ведущего двоеточия инициализатора класса.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="11688"/>
        <source>How to indent continued shift expressions (&apos;&lt;&lt;&apos; and &apos;&gt;&gt;&apos;).
...
-1: Preserve original indentation</source>
        ...
        <translation>Как сделать отступ для выражений с продолженным сдвигом (`&lt;&lt;` и `&gt;&gt;`).
...
-1: Сохранять исходный отступ</translation>
    ...
    <message>
        ...
        <source>Whether to ignore indent for &apos;{&apos; following &apos;case&apos;.</source>
        <comment>indent_ignore_case_brace</comment>
        <translation>Следует ли игнорировать отступ для &apos;{&apos; после &apos;case&apos;.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="11904"/>
...
- -1: Сохранить исходный отступ</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="11928"/>
        <source>How to indent a comma when inside braces.
 0: Indent by one level (default)
 1: Align under the open brace
-1: Preserve original indentation</source>
        <comment>indent_comma_brace</comment>
        <translation>Как сделать отступ для запятой внутри скобок.
...
- -1: Сохранить исходный отступ</translation>
    ...
    <message>
        ...
        <source>How to indent a comma when inside parentheses.
 0: Indent by one level (default)
 1: Align under the open parenthesis
-1: Preserve original indentation</source>
        <comment>indent_comma_paren</comment>
        <translation>Как сделать отступ для запятой внутри круглых скобок.
...
- -1: Сохранить исходный отступ</translation>
    ...
    <message>
        ...
        <source>How to indent a Boolean operator when inside parentheses.
 0: Indent by one level (default)
 1: Align under the open parenthesis
-1: Preserve original indentation</source>
        <comment>indent_bool_paren</comment>
        <translation>Как сделать отступ для булевого оператора внутри круглых скобок.
...
- -1: Сохранить исходный отступ</translation>
    ...
    <message>
        ...
        <source>Whether to ignore the indentation of a Boolean operator when outside
parentheses.</source>
        <comment>indent_ignore_bool</comment>
        <translation>Следует ли игнорировать отступ логического оператора, когда он находится за пределами круглых скобок.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="11952"/>
        <source>Whether to ignore the indentation of an arithmetic operator.</source>
        <comment>indent_ignore_arith</comment>
        <translation>Следует ли игнорировать отступы арифметического оператора.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="11964"/>
        <source>Whether to ignore the indentation of a semicolon outside of a &apos;for&apos;
statement.</source>
        <comment>indent_ignore_semicolon</comment>
        <translation>Следует ли игнорировать отступ от точки с запятой вне оператора `for`.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="11970"/>
        <source>Whether to align the first expression to following ones
if indent_bool_paren=1.</source>
        <comment>indent_first_bool_expr</comment>
        <translation>Выравнивать ли первое выражение по последующим, если indent_bool_paren=1.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="11994"/>
        <source>Whether to ignore the indentation of an assignment operator.</source>
        <comment>indent_ignore_assign</comment>
        <translation>Следует ли игнорировать отступы оператора присваивания.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="13004"/>
        <source>Whether to add a newline after the type in an unnamed temporary
direct-list-initialization, better:
before a direct-list-initialization.</source>
        <comment>nl_type_brace_init_lst</comment>
        <translation>Добавлять ли новую строку после типа в неименованном временном прямом списке инициализации.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="13864"/>
        <source>The span for aligning on &apos;{&apos; in braced init list.</source>
        <comment>align_braced_init_list_span</comment>
        <translation>Размах для выравнивания по &apos;{&apos; в скобочном списке инициализации.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="13864"/>
        <source>0: Don&apos;t align (default).</source>
    ...
    <message>
        ...
        <source>Whether to align on the left most assignment when multiple
definitions are found on the same line.
Depends on &apos;align_assign_span&apos; and &apos;align_assign_thresh&apos; settings.</source>
        <comment>align_assign_on_multi_var_defs</comment>
        <translation>Нужно ли выравнивать по самому левому присваиванию, если в одной строке встречается несколько определений.
Зависит от настроек &apos;align_assign_span&apos; и &apos;align_assign_thresh&apos;.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="13870"/>
        <source>The threshold for aligning on &apos;{&apos; in braced init list.
Use a negative number for absolute thresholds.</source>
        <comment>align_braced_init_list_thresh</comment>
        <translation>Порог для выравнивания по &apos;{&apos; в скобочном списке инициализации.
Для абсолютного порога используйте отрицательное число.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="13870"/>
        <source>0: No limit (default).</source>
...
alignment)</source>
        ...
        <translation>(OC) Выравнивать параметры в вызове сообщения Objective-C, если первое двоеточие не находится в следующей строке вызова сообщения (так же, как это делает Xcode)</translation>
    </message>
    <message>
...
specified by cmt_sp_after_star_cont.</source>
        ...
        <translation>Должен ли стартовый отступ свернутых строк соответствовать позиции начала несвернутого абзаца комментария (cmt_reflow_mode = 2). Отменяет значение, заданное cmt_sp_after_star_cont.

Фактически абзацный отступ</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="14160"/>
...
Требуется включить `cmt_align_doxygen_javadoc_tags`. Отменяет значение, заданное параметром `cmt_sp_after_star_cont`.</translation>
    ...
    <message>
        ...
        <translation>Заменять cpp-комментарии (//) на c-комментарии(/**/).</translation>
    </message>
    <message>
...
when converting to a c-comment.</source>
    ...
    <message>
        ...
        <translation>Количество пробелов, которое необходимо вставить после * в последующих строках комментариев.</translation>
    </message>
    <message>
...
&apos;$(filename)&apos;, that will be replaced with the current file&apos;s name.</source>
        ...
        <translation>Путь к файлу, содержащему текст для вставки в начало файла, если файл не начинается с комментария на языке Си/Си++. Если вставляемый текст содержит  `$(filename)`, он будет заменен на имя текущего файла.</translation>
    </message>
    <message>
...
&apos;$(filename)&apos;, that will be replaced with the current file&apos;s name.</source>
        ...
        <translation>Путь к файлу, содержащему текст для вставки в конец файла, если файл не начинается с комментария на языке Си/Си++. Если вставляемый текст содержит  `$(filename)`, он будет заменен на имя текущего файла.</translation>
    </message>
    <message>
...
cmt_insert_class_header.</source>
        <comment>cmt_insert_before_preproc</comment>
        <translation>Применяется к `cmt_insert_oc_msg_header`, `cmt_insert_func_header` и `cmt_insert_class_header`.</translation>
    </message>
    <message>
...
or destructor.</source>
    ...
    <message>
        ...
        <translation>Опции изменения комментариев</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="8604"/>
        <source>Code modifying options (non-whitespace) help</source>
        <translation>Опции модификации кода (не пробелы)</translation>
    </message>
    <message>
...
have, or do not have, braces. Overrides mod_full_brace_if.</source>
        <comment>mod_full_brace_if_chain</comment>
        <translation>Следует ли требовать, чтобы все блоки цепочки &apos;if&apos;/&apos;else if&apos;/&apos;else&apos; либо имели, либо не имели скобки. 
Отменяет mod_full_brace_if.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="14342"/>
        <source>0: Don&apos;t override mod_full_brace_if
...
3: Add braces to all blocks if any block needs braces and remove braces if
   ...
   despite none needing them</source>
        <comment>mod_full_brace_if_chain</comment>
        <translation>- 0: Не переопределять mod_full_brace_if
- 1: Добавить скобки во все блоки, если какой-либо блок нуждается в скобках, и удалить скобки, если они могут быть удалены из всех блоков.
- 2: Добавить скобки во все блоки, если в каком-либо блоке уже есть скобки, независимо от того, нужны ли они ему.
- 3: Добавить скобки во все блоки, если любой блок нуждается в скобках, и удалить скобки, если они могут быть удалены из всех блоков, за исключением случаев, когда все блоки имеют скобки, несмотря на то, что ни один из них в них не нуждается.</translation>
    </message>
    <message>
...
which span multiple lines.</source>
  ...
  mod_full_brace_using</source>
        <comment>mod_full_brace_nl_block_rem_mlcond</comment>
        <translation>Применяется к:
  `mod_full_brace_for`,
  `mod_full_brace_if`,
  `mod_full_brace_if_chain`,
  `mod_full_brace_if_chain_only`,
  `mod_full_brace_while`,
  `mod_full_brace_using`</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="14372"/>
...
statement, as in &apos;if (a &amp;&amp; b &gt; c)&apos; =&gt; &apos;if (a &amp;&amp; (b &gt; c))&apos;.</source>
    ...
    <message>
        ...
        <source>Whether to fully parenthesize Boolean expressions after &apos;=&apos;
statement, as in &apos;x = a &amp;&amp; b &gt; c;&apos; =&gt; &apos;x = (a &amp;&amp; (b &gt; c));&apos;.</source>
        <comment>mod_full_paren_assign_bool</comment>
        <translation>Полностью заключать в круглые скобки булевы выражения после оператора `=`  как в `x = a &amp;amp;&amp;amp; b &amp;gt; c;` =&amp;gt; `x = (a &amp;amp;&amp;amp; (b &amp;gt; c));`</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="14408"/>
        <source>Whether to fully parenthesize Boolean expressions after &apos;=&apos;
statement, as in &apos;return  a &amp;&amp; b &gt; c;&apos; =&gt; &apos;return (a &amp;&amp; (b &gt; c));&apos;.</source>
        <comment>mod_full_paren_return_bool</comment>
        <translation>Полностью заключать в круглые скобки булевы выражения после оператора return как в `return a &amp;amp;&amp;amp; b &amp;gt; c;` =&amp;gt; `return (a &amp;amp;&amp;amp; (b &amp;gt; c));`</translation>
    </message>
    <message>
...
filename without extension when sorting is enabled.</source>
        ...
        <translation>Отдавать приоритет утверждения `#include` и `#import`, которые содержат имя файла без расширения, при сортировке.</translation>
    </message>
    <message>
...
contain extensions when sorting is enabled.</source>
        ...
        <translation>Отдавать приоритет утверждения `#include` и `#import`, которые содержат имя файла с расширением, при сортировке.</translation>
    </message>
    <message>
...
the close brace, as in &apos;case X: { ... } break;&apos; =&gt; &apos;case X: { ... break; }&apos;.</source>
    ...
    <message>
        ...
        <source>Whether to move a &apos;return&apos; that appears after a fully braced &apos;case&apos; before
the close brace, as in &apos;case X: { ... } return;&apos; =&gt; &apos;case X: { ... return; }&apos;.</source>
        <comment>mod_move_case_return</comment>
        <translation>Нужно ли перемещать &apos;return&apos;, который появляется после полностью заключенного в скобки &apos;case&apos; перед закрывающей скобкой, как в `case X: { ... } return;` =&amp;gt; `case X: { ... return; }`.</translation>
    </message>
    <message>
...
function.</source>
    ...
    <message>
        ...
        <translation>Добавить или убрать запятую после последнего значения перечисления.

    enum con{one,two,tre,};</translation>
    </message>
    <message>
...
&apos;null_resettable&apos;) when organizing properties.</source>
    ...
    <message>
        ...
        <translation>Опции препроцессора</translation>
    </message>
    <message>
...
at brace level 0 (file-level).</source>
        ...
        <translation>Добавить или убрать отступы директив препроцессора внутри блоков #if на уровне скобок 0 (на уровне файла).</translation>
    </message>
    <message>
...
indented from column 1.</source>
        ...
        <translation>Делать отступ #if/#else/#endif на уровне скобок. Если false, то отступ от столбца 1.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="14680"/>
        <source>Whether to indent #if/#else/#endif at the parenthesis level if the brace
level is 0. If false, these are indented from column 1.</source>
        <comment>pp_indent_at_level0</comment>
        <translation>Делать ли отступ #if/#else/#endif на уровне скобок, если уровень скобок равен 0. Если false, то отступы делаются от столбца 1.</translation>
    </message>
    <message>
...
&gt;0: Column at which all preprocessors will be indented</source>
        <comment>pp_indent_if</comment>
        <translation>- =0: Отступ препроцессоров с использованием `output_tab_size`
- &gt;0: Столбец, на уровне которого будут отступать все препроцессоры</translation>
    ...
    <message>
        ...
        <translation>Можно сделать отступ между #if, #else и #endif.</translation>
    </message>
    <message>
        ...
        <translation>Делать отступ в теле #if, который охватывает весь код в файле.</translation>
    </message>
    <message>
...
indented from column 1.</source>
        ...
        <translation>Делать отступ `#define` на уровне скобок. Если false, то отступ от столбца 1.</translation>
    </message>
    <message>
        ...
        <translation>Делать отступ `#include` на уровне скобок.</translation>
    </message>
    <message>
    ...
    <message>
        <location filename="ui_0771f.py" line="14484"/>
        <source>Whether to print warning messages for unbalanced #if and #else blocks.
This will print a message in the following cases:
- if an #ifdef block ends on a different indent level than
  where it started from. Example:</source>
        <comment>pp_warn_unbalanced_if</comment>
        <translation>Выводить ли предупреждающие сообщения для несбалансированных блоков #if и #else.

Сообщение будет выводиться в следующих случаях:

- если блок #ifdef заканчивается на другом уровне отступа, чем  с которого он начинался. 
...
Пример:</translation>
    ...
    <message>
        <location filename="ui_0771f.py" line="14484"/>
        <source>- an #elif/#else block ends on a different indent level than
  the corresponding #ifdef block. Example:</source>
        <comment>pp_warn_unbalanced_if</comment>
        <translation>- блок #elif/#else заканчивается на другом уровне отступа, чем  соответствующий блок #ifdef. 
...
Пример:</translation>
    ...
    <message>
        ...
        <translation>Опции сортировки включений

Использовать с осторожностью. Могут полностью сломать сборку</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Опции сортировки включений</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="9540"/>
        <source>Use or Do not Use options help</source>
        <translation>Опции использования</translation>
    </message>
    <message>
...
- an assignment: your case with pSettings = new QSettings( ...</source>
        ...
        <translation>Значение отступа для строки продолжения вычисляется по-разному, если утверждение является:

- объявлением: ваш случай с `QString fileName ...`
- присвоением: ваш случай с `pSettings = new QSettings( ...`</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="14816"/>
...
- false: indent_continue будет использоваться каждый раз (по умолчанию)</translation>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="14816"/>
        <source>Requires indent_ignore_first_continue=false.</source>
        <comment>use_indent_continue_only_once</comment>
        <translation>Требуется indent_ignore_first_continue=false.</translation>
    </message>
    <message>
...
characters. See https://en.cppreference.com/w/cpp/string/byte/isspace.</source>
        ...
        <translation>Если `true`: символ подачи формы удаляется из списка пробельных символов. 
...
См. https://en.cppreference.com/w/cpp/string/byte/isspace.</translation>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="9615"/>
        <source>Warn levels - 1: error, 2: warning (default), 3: note help</source>
        <translation>Уровень предупреждений - 1: ошибка, 2: предупреждение (default), 3: информирование</translation>
    </message>
    <message>
...
in a C# verbatim string literal.</source>
        ...
        <translation>(C#) Выдавать предупреждение при замене tab на \t, найденных в строковом литерале на C#.</translation>
    </message>
    <message>
...
0: не усекать.</translation>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="10054"/>
        <source>Add or remove space between a qualifier and a pointer star &apos;*&apos; that isn&apos;t
followed by a variable name, as in &apos;(char const *)&apos;. If set to ignore,
sp_before_ptr_star is used instead.</source>
        <comment>sp_qualifier_unnamed_ptr_star</comment>
        <translation>Добавить или убрать пробел между классификатором и звездой указателя &apos;*&apos;, за которой не следует имя переменной, как в &apos;(char const *)&apos;. Если установлено значение ignore, вместо этого используется sp_before_ptr_star.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="10120"/>
...
used instead.</source>
        ...
        <translation>Добавить или убрать пробел перед звездой указателя &apos;*&apos;, если за ней следует прототипа или определение функции. Если установлено значение ignore, то вместо него используется sp_before_ptr_star используется вместо этого.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="10126"/>
        <source>Add or remove space between a qualifier and a pointer star &apos;*&apos; followed by
the name of the function in a function prototype or definition, as in
&apos;char const *foo()`. If set to ignore, sp_before_ptr_star is used instead.</source>
        <comment>sp_qualifier_ptr_star_func</comment>
        <translation>Добавить или убрать пробел между классификатором и звездой-указателем &apos;*&apos;, за которой следует имя функции в прототипе или определении функции, как в &apos;char const *foo()`. Если установлено значение ignore, то вместо этого используется sp_before_ptr_star.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="10138"/>
        <source>Add or remove space between a qualifier and a pointer star &apos;*&apos; in the
trailing return of a function prototype or function definition, as in
&apos;auto foo() -&gt; char const *&apos;.</source>
        <comment>sp_qualifier_ptr_star_trailing</comment>
        <translation>Добавить или убрать пробел между классификатором и звездочкой указателя &apos;*&apos; в конце возврата прототипа функции или определения функции, как в примере &apos;auto foo() -&gt; char const *&apos;.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="10468"/>
        <source>(C#, Vala) Add or remove space between &apos;,&apos; and &apos;]&apos; in multidimensional array type
like &apos;int[,,]&apos;.</source>
        <comment>sp_after_mdatype_commas</comment>
        <translation>(C#, Vala) Добавить или убрать пробел между &apos;,&apos; и &apos;]&apos; в типе многомерного массива например, &apos;int[,,]&apos;.</translation>
    </message>
    <message>
...
like &apos;int[,,]&apos;.</source>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="10480"/>
        <source>(C#, Vala) Add or remove space between &apos;,&apos; in multidimensional array type
like &apos;int[,,]&apos;.</source>
        <comment>sp_between_mdatype_commas</comment>
        <translation>(C#, Vala) Добавить или убрать пробел между &apos;,&apos; в многомерных массивах типа &apos;int[,,]&apos;.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="10762"/>
        <source>Add or remove space inside user functor &apos;(&apos; and &apos;)&apos;.</source>
        <comment>sp_func_call_user_inside_rparen</comment>
        <translation>Добавить или убрать пробел внутри пользовательских функций &apos;(&apos; и &apos;)&apos;.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="10768"/>
        <source>Add or remove space inside empty functor &apos;()&apos;.
Overrides sp_after_angle unless use_sp_after_angle_always is set to true.</source>
        <comment>sp_inside_rparens</comment>
        <translation>Добавить или удалить пробел внутри пустого функтора &apos;()&apos;.
Переопределяет sp_after_angle, если для параметра use_sp_after_angle_always не установлено значение true.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="10774"/>
        <source>Add or remove space inside functor &apos;(&apos; and &apos;)&apos;.</source>
        <comment>sp_inside_rparen</comment>
        <translation>Добавить или убрать пробел внутри функтора &apos;(&apos; и &apos;)&apos;.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="11290"/>
        <source>remove space after the &apos;//&apos; and the pvs command &apos;-V1234&apos;,
only works with sp_cmt_cpp_start set to add or force.</source>
        <comment>sp_cmt_cpp_pvs</comment>
        <translation>убрать пробел после &apos;//&apos; и команды pvs &apos;-V1234&apos;, работает только в том случае, если для sp_cmt_cpp_start установлено значение add или force.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="11296"/>
        <source>remove space after the &apos;//&apos; and the command &apos;lint&apos;,
only works with sp_cmt_cpp_start set to add or force.</source>
        <comment>sp_cmt_cpp_lint</comment>
        <translation>убрать пробел после &apos;//&apos; и команды &apos;lint&apos;, работает только в том случае, если для sp_cmt_cpp_start установлено значение add или force.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="11344"/>
        <source>Add or remove space inside parentheses of the new operator
as in &apos;new(foo) BAR&apos;.</source>
        <comment>sp_inside_newop_paren</comment>
        <translation>Добавить или убрать пробел внутри круглых скобок оператора new как в выражении &apos;new(foo) BAR&apos;.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="12114"/>
...
2: When the `:` is a continuation, indent it under `?`</source>
        <comment>indent_ternary_operator</comment>
        <translation>0: Выключено (по умолчанию)
1: Если `if_false` является продолжением, отступ от него ставится под веткой `if_true`.
2: Если `:` является продолжением, отступ делается под веткой `?`.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="12158"/>
        <source>Whether to collapse empty blocks between &apos;{&apos; and &apos;}&apos; except for functions.
Use nl_collapse_empty_body_functions to specify how empty function braces
should be formatted.</source>
        <comment>nl_collapse_empty_body</comment>
        <translation>Нужно ли сворачивать пустые блоки между &apos;{&apos; и &apos;}&apos;, за исключением функций. Используйте nl_collapse_empty_body_functions, чтобы указать, как должны быть отформатированы пустые скобки функций.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="12164"/>
        <source>Whether to collapse empty blocks between &apos;{&apos; and &apos;}&apos; for functions only.
If true, overrides nl_inside_empty_func.</source>
        <comment>nl_collapse_empty_body_functions</comment>
        <translation>Нужно ли сворачивать пустые блоки между &apos;{&apos; и &apos;}&apos; только для функций.
Если true, то переопределяет nl_inside_empty_func.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="12944"/>
        <source>(OC) Minimum number of Objective-C message parameters before applying nl_oc_msg_args.</source>
        <comment>nl_oc_msg_args_min_params</comment>
        <translation>(OC) Минимальное количество параметров сообщения Objective-C перед применением nl_oc_msg_args.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="12950"/>
        <source>(OC) Max code width of Objective-C message before applying nl_oc_msg_args.</source>
        <comment>nl_oc_msg_args_max_code_width</comment>
        <translation>(OC) Максимальная ширина кода сообщения Objective-C до применения nl_oc_msg_args.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="12986"/>
        <source>Add or remove newline between &apos;throw&apos; and the throw expression.</source>
        <comment>nl_throw_expr</comment>
        <translation>Добавить или удалить новую строку между &apos;throw&apos; и выражением throw.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="13294"/>
        <source>The number of newlines inside an empty function body.
This option overrides eat_blanks_after_open_brace and
eat_blanks_before_close_brace, but is ignored when
nl_collapse_empty_body_functions=true</source>
        <comment>nl_inside_empty_func</comment>
        <translation>Количество новых строк внутри пустого тела функции. Эта опция переопределяет eat_blanks_after_open_brace и eat_blanks_before_close_brace, но игнорируется, если nl_collapse_empty_body_functions=true</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="13402"/>
        <source>The minimum number of blank lines after a block of variable definitions
...
before trailing preprocessor directives, if any exist.</source>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="13408"/>
        <source>The minimum number of empty newlines before a block of variable definitions
...
preprocessor directives before the block.</source>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="13414"/>
        <source>The minimum number of empty newlines after a block of variable definitions
...
3: Выравнивание по косой черте, расположенной дальше всего вправо</translation>
    ...
    <message>
        ...
        <source>the following options (mod_XX_closebrace_comment) use different comment,
...
true : Использовать комментарий cpp</translation>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="14552"/>
        <source>0: Leave syntax alone (default)
1: Rewrite as `for(;;)`
...
5: Переписать как `do`...`while(1);`</translation>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="14552"/>
        <source>Infinite loops that do not already match one of these syntaxes are ignored.
...
Другие опции, влияющие на форматирование циклов, будут применены после преобразования синтаксиса.</translation>
    ...
    <message>
        ...
        <source>If there is a situation where mod_int_* and mod_*_int would result in
...
leftmost int.</source>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="14662"/>
        <source>-1: Use &apos;indent_with_tabs&apos; setting (default)
 0: Spaces only
 ...
 2: Отступ и выравнивание с помощью табуляции, использование пробелов, если нет ограничителя табуляции</translation>
    ...
    <message>
        ...
        <source>An offset value that controls the indentation of the body of a multiline #define.
...
Требуется &apos;pp_ignore_define_body = false&apos;.</translation>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="14752"/>
        <source> &lt;0: Absolute column: the body indentation starts off at the specified column
...
Применяется только к отступу препроцессора, внутри которого непосредственно находится блок extern.</translation>
    ...
    <message>
        ...
        <source>How to indent braces directly inside #if, #else, and #endif.
...
только если установлена опция -p.</translation>
    ...
    <message>
        ...
        <comment>sp_between_ptr_star</comment>
        <translation>Добавить или убрать пробел между символами указателя &apos;*&apos;.</translation>
    </message>
    <message>
        <location filename="ui_073.py" line="7474"/>
        <source>Add or remove space after a pointer star &apos;*&apos;, if followed by an open
parenthesis, as in &apos;void* (*)().</source>
        <comment>sp_ptr_star_paren</comment>
        <translation>Добавить или убрать пробел после звезды указателя &apos;*&apos;, если за ней следует открывающая скобки, как в void* (*)().</translation>
    </message>
    <message>
...
prototype or function definition.</source>
        <comment>sp_before_ptr_star_func</comment>
        <translation>Добавить или убрать пробел перед звездой указателя &apos;*&apos;, если за ней следует прототип или определение функции.</translation>
    </message>
    <message>
        <location filename="ui_073.py" line="7474"/>
        <source>Add or remove space inside &apos;(&apos; and &apos;)&apos; of control statements.</source>
        <comment>sp_inside_sparen</comment>
        <translation>Добавить или убрать пробел внутри `(` и `)` управляющих операторов</translation>
    </message>
    <message>
        <location filename="ui_073.py" line="7474"/>
        <source>Add or remove space after &apos;(&apos; of control statements.</source>
        <comment>sp_inside_sparen_open</comment>
        <translation>Добавить или убрать пробел после `(` в управляющих конструкциях.</translation>
    </message>
    <message>
        <location filename="ui_073.py" line="7474"/>
        <source>Add or remove space before &apos;)&apos; of control statements.</source>
        <comment>sp_inside_sparen_close</comment>
        <translation>Добавить или убрать пробел перед `)` в управляющих операторах</translation>
    </message>
    <message>
        <location filename="ui_073.py" line="7474"/>
        <source>Add or remove space between &apos;)&apos; and &apos;{&apos; of of control statements.</source>
        <comment>sp_sparen_brace</comment>
        <translation>Добавьте или уберите пробел между &apos;)&apos; и &apos;{&apos; управляющих операторов.</translation>
    </message>
    <message>
        <location filename="ui_073.py" line="7474"/>
        <source>Add or remove space before a semicolon of an empty part of a for statement.</source>
        <comment>sp_before_semi_for_empty</comment>
        <translation>Добавить или убрать пробел перед точкой с запятой пустой части оператора `for`</translation>
    </message>
    <message>
        <location filename="ui_073.py" line="7474"/>
        <source>Add or remove space before &apos;,&apos;.</source>
        <comment>sp_before_comma</comment>
        <translation>Добавить или убрать пробел перед &apos;,&apos;.</translation>
    </message>
    <message>
        <location filename="ui_075.py" line="7995"/>
...
like &apos;int[,,]&apos;.</source>
        <comment>sp_after_mdatype_commas</comment>
        <translation>(C#) Добавить или убрать пробел между &apos;,&apos; и &apos;]&apos; в типе многомерного массива например, &apos;int[,,]&apos;.</translation>
    </message>
    <message>
        <location filename="ui_075.py" line="7995"/>
        <source>(C#) Add or remove space between &apos;[&apos; and &apos;,&apos; in multidimensional array type
...
like &apos;int[,,]&apos;.</source>
        <comment>sp_between_mdatype_commas</comment>
        <translation>(C#) Добавить или убрать пробел между символами &apos;,&apos; в типе многомерного массива например, &apos;int[,,]&apos;.</translation>
    </message>
    <message>
        <location filename="ui_073.py" line="7474"/>
        <source>Add or remove space before the variadic &apos;...&apos; when preceded by a
non-punctuator.</source>
        <comment>sp_before_ellipsis</comment>
        <translation>Добавьте или уберите пробел перед вариативным &apos;...&apos;, когда ему предшествует непунктуатор.</translation>
    </message>
    <message>
...
direct-list-initialization.</source>
        <comment>sp_after_type_brace_init_lst_open</comment>
        <translation>Добавить или убрать пробел после открывающей скобки в безымянном временном прямом списке-инициализации.</translation>
    </message>
    <message>
        <location filename="ui_073.py" line="7474"/>
        <source>Add or remove space before close brace in an unnamed temporary
direct-list-initialization.</source>
        <comment>sp_before_type_brace_init_lst_close</comment>
        <translation>Добавить или убрать пробел перед закрывающей скобкой в безымянном временном прямом списке-инициализации</translation>
    </message>
    <message>
        <location filename="ui_073.py" line="7474"/>
        <source>Add or remove space inside an unnamed temporary direct-list-initialization.</source>
        <comment>sp_inside_type_brace_init_lst</comment>
        <translation>Добавить или убрать пробел внутри безымянного временного прямого списка-инициализации</translation>
    </message>
    <message>
        <location filename="ui_075.py" line="7995"/>
...
as in &apos;new(foo) BAR&apos;.</source>
    ...
    <message>
        ...
        <comment>sp_before_tr_emb_cmt</comment>
        <translation>Добавить или убрать пробел перед примыкающим или встроенным комментарием.</translation>
    </message>
    <message>
        <location filename="ui_073.py" line="7474"/>
        <source>Number of spaces before a trailing or embedded comment.</source>
        <comment>sp_num_before_tr_emb_cmt</comment>
        <translation>Количество пробелов перед завершающими или встроенным комментарием.</translation>
    </message>
    <message>
        <location filename="ui_074.py" line="7813"/>
        <source>For FreeBSD, this is set to 4.</source>
        <comment>indent_continue</comment>
        <translation>Для FreeBSD это значение равно 4.</translation>
    </message>
    <message>
        <location filename="ui_074.py" line="7813"/>
        <source>The continuation indent, only for class header line(s). If non-zero, this
overrides the indent of &apos;class&apos; continuation indents.</source>
        <comment>indent_continue_class_head</comment>
        <translation>Отступ продолжения, только для строки (строк) заголовка класса. Если значение ненулевое, это переопределяет отступ продолжения &apos;class&apos;.</translation>
    </message>
    <message>
        <location filename="ui_074.py" line="7813"/>
        <source>Additional indent before the leading base class colon.
...
and nl_class_colon)</source>
        ...
        <translation>Дополнительный отступ перед ведущим двоеточием базового класса.
Отрицательные значения уменьшают отступ до первого столбца.
Требуется перенос строки перед двоеточием (см. pos_class_colon и nl_class_colon).</translation>
    </message>
    <message>
        <location filename="ui_073.py" line="7474"/>
...
aligning. Set align_left_shift=false when enabling this.</source>
    ...
    <message>
        <location filename="ui_073.py" line="7474"/>
        <source>Spaces to indent single line (&apos;//&apos;) comments on lines before code.</source>
        <comment>indent_sing_line_comments</comment>
        <translation>Пробелы для отступов однострочных (&apos;//&apos;) комментариев.</translation>
    </message>
    <message>
        <location filename="ui_073.py" line="7474"/>
        <source>Spaces to indent &apos;case&apos; from &apos;switch&apos;. Usually 0 or indent_columns.
It might wise to choose the same value for the option indent_case_brace.</source>
        <comment>indent_switch_case</comment>
        <translation>Размер отступа `case` от `switch`. Обычно 0 или `indent_columns`.
Возможно, будет разумно выбрать такое же значение для параметра `indent_case_brace`.
    ...
    <message>
        ...
        <source>Spaces to indent &apos;{&apos; from &apos;case&apos;. By default, the brace will appear under
the &apos;c&apos; in case. Usually set to 0 or indent_columns. Negative values are OK.
It might wise to choose the same value for the option indent_switch_case.</source>
        <comment>indent_case_brace</comment>
        <translation>Пробел для отступа `{` от `case`. По умолчанию скобка будет отображаться под буквой `c` в `case`. 
...
2: Indent to the brace level</source>
        <comment>indent_paren_close</comment>
        <translation>0: Отступ до уровня тела (по умолчанию)
1: Выравнивание по открытой скобке
...
such code into four lines.</source>
    ...
    <message>
        <location filename="ui_073.py" line="7474"/>
        <source>Whether to split one-line simple unbraced if statements into three lines by
adding newlines, as in &apos;int a[12] = { &lt;here&gt; 0 &lt;here&gt; };&apos;.</source>
        <comment>nl_create_list_one_liner</comment>
        <translation>Разделять простые однострочные операторы без скобок на две строки путём добавлением новой строки,

    int a[12] = { &lt;here&gt; 0 &lt;here&gt; };</translation>
    </message>
    <message>
        <location filename="ui_075.py" line="7995"/>
        <source>The number of newlines inside an empty function body.
...
nl_collapse_empty_body=true</source>
        <comment>nl_inside_empty_func</comment>
        <translation>Количество новых строк внутри пустого тела функции. Эта опция переопределяет eat_blanks_after_open_brace и eat_blanks_before_close_brace, но игнорируется, если nl_collapse_empty_body=true</translation>
    </message>
    <message>
        <location filename="ui_075.py" line="7995"/>
...
aligment)</source>
        <comment>align_oc_msg_colon_xcode_like</comment>
        <translation>(OC) Не выравнивать ли параметры в вызове сообщения Objectve-C, если первое двоеточие не находится в следующей строке вызова сообщения (аналогично тому, как это делает Xcode)</translation>
    </message>
    <message>
        <location filename="ui_074.py" line="7813"/>
        <source>Whether to enforce that all blocks of an &apos;if&apos;/&apos;else if&apos;/&apos;else&apos; chain either
...
blocks.</source>
    ...
    <message>
        ...
        <comment>pp_space_count</comment>
        <translation>Устанавливает количество пробелов на уровень, добавляемых с помощью pp_space.</translation>
    </message>
    <message>
        <location filename="ui_075.py" line="7995"/>
        <source>Whether to indent case statements between #if, #else, and #endif.
...
is directly inside of.</source>
        <comment>pp_indent_func_def</comment>
        <translation>Делать ли отступы между #if, #else и #endif для определений функций.
Применяется только к отступу препроцессора, непосредственно внутри которого находится определение функции.</translation>
    </message>
    <message>
        <location filename="ui_075.py" line="7995"/>
        <source>Whether to indent extern C blocks between #if, #else, and #endif.
...
value &apos;true&apos;.</source>
        <comment>indent_cpp_lambda_only_once</comment>
        <translation>Чтобы предотвратить двойное использование значения отступа, используйте этот параметр со значением `true`.</translation>
    </message>
    <message>
        <location filename="ui_074.py" line="7813"/>
...
The value REMOVE will be overriden with FORCE</source>
        <comment>sp_before_ellipsis</comment>
        <translation>Добавить или убрать пробел перед вариативным &apos;...&apos;, когда ему предшествует непунктуатор.
Значение REMOVE будет отменено значением FORCE</translation>
    </message>
    <message>
        <location filename="ui_075.py" line="7995"/>
        <source>The number of empty newlines before a block of variable definitions
not at the top of a function body. If nl_after_access_spec is non-zero,
...
-1: Сохранять исходный отступ</translation>
    ...
    <message>
        ...
        <source>The indentation can be:
- after the assignment, at the &apos;[&apos; character
- at the begin of the lambda body</source>
        <comment>indent_cpp_lambda_only_once</comment>
        <translation>Отступ может быть:
- после присваивания, на символе &apos;[&apos;
- в начале тела лямбды</translation>
...
false: отступ будет в начале тела лямбды (по умолчанию)</translation>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="9880"/>
        <source>Add or remove space after the opening parenthesis and before the closing
parenthesis of a argument list of a C++11 lambda, as in
&apos;[]( &lt;here&gt; ){ ... }&apos;
with an empty list.</source>
        <comment>sp_cpp_lambda_argument_list_empty</comment>
        <translation>Добавить или убрать пробел после открывающей скобки и перед закрывающей скобкой в пустом списке аргументов лямбды C++11 &apos;[]( &lt;here&gt; ){ ... }&apos;</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="10030"/>
        <source>Add or remove space before pointer star &apos;*&apos; that is followed by a qualifier.
If set to ignore, sp_before_unnamed_ptr_star is used instead.</source>
        <comment>sp_before_qualifier_ptr_star</comment>
        <translation>Добавить или удалить пробел перед звездочкой указателя &apos;*&apos;, за которой следует квалификатор.
Если установлено значение ignore, вместо этого используется sp_before_unnamed_ptr_star.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="10036"/>
        <source>Add or remove space before pointer star &apos;*&apos; that is followed by &apos;operator&apos; keyword.
If set to ignore, sp_before_unnamed_ptr_star is used instead.</source>
        <comment>sp_before_operator_ptr_star</comment>
        <translation>Добавить или удалить пробел перед звездочкой указателя &apos;*&apos;, за которой следует ключевое слово &apos;operator&apos;.
Если установлено значение ignore, вместо этого используется sp_before_unnamed_ptr_star.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="10042"/>
        <source>Add or remove space before pointer star &apos;*&apos; that is followed by
a class scope (as in &apos;int *MyClass::method()&apos;) or namespace scope
(as in &apos;int *my_ns::func()&apos;).
If set to ignore, sp_before_unnamed_ptr_star is used instead.</source>
        <comment>sp_before_scope_ptr_star</comment>
        <translation>Добавить или убрать пробел перед звездой указателя &apos;*&apos;, за которой следует область видимости класса (как в &apos;int *MyClass::method()&apos;) или область видимости пространства имен (как в &apos;int *my_ns::func()&apos;).
Если установлено значение ignore, вместо этого используется sp_before_unnamed_ptr_star.</translation>
    </message>
    <message>
...
as in &apos;int *::func()&apos;.
If set to ignore, sp_before_unnamed_ptr_star is used instead.</source>
        <comment>sp_before_global_scope_ptr_star</comment>
        <translation>Добавить или удалить пробел перед звездой указателя &apos;*&apos;, за которой следует &apos;::&apos;,
как в &apos;int *::func()&apos;.
Если установлено значение ignore, вместо этого используется sp_before_unnamed_ptr_star.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="10066"/>
        <source>Add or remove space between pointer star &apos;*&apos; and reference &apos;&amp;&apos;, as in &apos;int *&amp; a;&apos;.</source>
        <comment>sp_between_ptr_ref</comment>
        <translation>Добавьте или уберите пробел между звездой указателя &apos;*&apos; и ссылкой &apos;&amp;&apos;, как в &apos;int *&amp; a;&apos;.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="10216"/>
        <source>Add or remove space inside &apos;&lt;&gt;&apos;.
if empty.</source>
        <comment>sp_inside_angle_empty</comment>
        <translation>Добавить или убрать пробел внутри пустых `&lt;&gt;`.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="10444"/>
        <source>Add or remove space inside &apos;[]&apos;.
if empty.</source>
        <comment>sp_inside_square_empty</comment>
        <translation>Добавить или убрать пробел внутри &apos;[]&apos;.
Если пусто.</translation>
    </message>
    <message>
...
if empty.</source>
        <comment>sp_func_proto_paren_empty</comment>
        <translation>Добавить или убрать пробел между именем функции и пустыми скобками &apos;()&apos; при объявлении функции.</translation>
    </message>
    <message>
...
if empty.</source>
        <comment>sp_func_def_paren_empty</comment>
        <translation>Добавить или убрать пробел между именем функции и пустыми скобками &apos;()&apos; при определении функции.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="11428"/>
        <source>Add or remove space before a bit colon &apos;:&apos;.</source>
        <comment>sp_before_bit_colon</comment>
        <translation>Добавить или удалять пробел перед двоеточием.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="11434"/>
        <source>Add or remove space after a bit colon &apos;:&apos;.</source>
        <comment>sp_after_bit_colon</comment>
        <translation>Добавbnm или уберfnm пробел после двоеточия &apos;:&apos;.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="13354"/>
        <source>Overrides nl_min_after_func_body and nl_max_after_func_body.</source>
        <comment>nl_after_func_body</comment>
        <translation>Переопределяет nl_min_after_func_body и nl_max_after_func_body.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="13360"/>
        <source>The minimum number of newlines after &apos;}&apos; of a multi-line function body.</source>
        <comment>nl_min_after_func_body</comment>
        <translation>Минимальное количество новых строк после &apos;}&apos; в многострочном теле функции.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="13360"/>
        <source>Only works when nl_after_func_body is 0.</source>
        <comment>nl_min_after_func_body</comment>
        <translation>Работает только в том случае, если nl_after_func_body равно 0.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="13366"/>
        <source>The maximum number of newlines after &apos;}&apos; of a multi-line function body.</source>
        <comment>nl_max_after_func_body</comment>
        <translation>Максимальное количество новых строк после &apos;}&apos; в многострочном теле функции.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="13366"/>
        <source>Only works when nl_after_func_body is 0.
Takes precedence over nl_min_after_func_body.</source>
        <comment>nl_max_after_func_body</comment>
        <translation>Работает только в том случае, если nl_after_func_body равно 0. 
Имеет приоритет перед nl_min_after_func_body.</translation>
    </message>
    <message>
...
new lines for the function prototype alignment&apos;s span.</source>
    ...
    <message>
        <location filename="uncrustify_ui.py" line="14002"/>
        <source>false: continuation lines are part of the newlines count
true:  continuation lines are not counted</source>
        <comment>align_func_proto_span_ignore_cont_lines</comment>
        <translation>false: строки продолжения учитываются при подсчете новых строк
true: строки продолжения не учитываются</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="14074"/>
        <source>The minimum number of spaces between the end of a line and its continuation
backslash. Requires align_nl_cont.</source>
        <comment>align_nl_cont_spaces</comment>
        <translation>Минимальное количество пробелов между концом строки и ее маркером продолжения (обратная косая черта). Требуется align_nl_cont.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="14890"/>
        <source>use (or not) the exit(EX_SOFTWARE) function.</source>
        <comment>debug_use_the_exit_function_pop</comment>
        <translation>использовать (или не использовать) функцию exit(EX_SOFTWARE).</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="10354"/>
        <source>Add or remove space before empty statement &apos;;&apos; on &apos;if&apos;, &apos;for&apos; and &apos;while&apos;.
examples:
  if (b) &lt;here&gt; ;
  for (a=1; a&lt;10; a++) &lt;here&gt; ;
  while (*p++ = &apos; &apos;) &lt;here&gt; ;</source>
        <comment>sp_special_semi</comment>
        <translation>Добавить или убрать пробел перед пустым выраджением &apos;;&apos; в &apos;if&apos;, &apos;for&apos; и &apos;while&apos;.
например:
  if (b) &lt;here&gt; ;
  for (a=1; a&lt;10; a++) &lt;here&gt; ;
  while (*p++ = &apos; &apos;) &lt;here&gt; ;</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="10426"/>
        <source>Add or remove space before C++17 structured bindings
after byref.</source>
        <comment>sp_cpp_before_struct_binding_after_byref</comment>
        <translation>Добавить или убрать пробел перед структурированными связками C++17 после byref.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="11398"/>
        <source>Embedded comment spacing options have higher priority (== override)
than other spacing options (comma, parenthesis, braces, ...)</source>
        <comment>sp_emb_cmt_priority</comment>
        <translation>Параметры интервала между встроенными комментариями имеют более высокий приоритет (== переопределяет) чем другие параметры интервалов (запятая, скобки ...)</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="11446"/>
        <source>Add or remove space between two strings.</source>
        <comment>sp_string_string</comment>
        <translation>Добавить или удалить пробел между двумя строками.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="11452"/>
        <source>Add or remove space &apos;struct&apos; and a type.</source>
        <comment>sp_struct_type</comment>
        <translation>Добавить или удалить пробел &apos;struct&apos; и типом.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="12956"/>
        <source>(OC) Whether to apply nl_oc_msg_args if some of the parameters are already
on new lines. Overrides nl_oc_msg_args_min_params and nl_oc_msg_args_max_code_width.</source>
        <comment>nl_oc_msg_args_finish_multi_line</comment>
        <translation>(OC) Применять ли nl_oc_msg_args, если некоторые параметры уже находятся в новых строках. Переопределяет nl_oc_msg_args_min_params и nl_oc_msg_args_max_code_width.</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="14782"/>
        <source>Action to perform when unbalanced #if and #else blocks are found.
0: do nothing
1: print a warning message
2: terminate the program with an error (EX_SOFTWARE)</source>
        <comment>pp_unbalanced_if_action</comment>
        <translation>Действие, выполняемое при обнаружении несбалансированных блоков #if и #else.
0: ничего не делать
1: вывести предупреждение
2: завершить программу с ошибкой (EX_SOFTWARE)</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="14782"/>
        <source>The action will be triggered in the following cases:
- if an #ifdef block ends on a different indent level than
  where it started from. Example:</source>
        <comment>pp_unbalanced_if_action</comment>
        <translation>Действие срабатывает в следующих случаях:
- если блок #ifdef заканчивается на уровне отступа, отличном от того.
  с которого он начинался. Пример:</translation>
    </message>
    <message>
        <location filename="uncrustify_ui.py" line="14782"/>
        <source>   #ifdef TEST
...
Пример:</translation>
    ...
    <message>
        ...
        <source>print (or not) the version in the file defined at the command option -o.</source>
        <comment>debug_print_version</comment>
        <translation>вывести (или не вывести) версию в файле, заданном опцией команды -o.</translation>
    </message>
</context>
</TS>
